...
{
    public partial class PaymentDefaultCreditBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentCreditBankPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentCreditBankPopup");
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "CreditBankCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BankCode").ToString() +
