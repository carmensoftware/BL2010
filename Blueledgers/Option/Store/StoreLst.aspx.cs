...
{
    public partial class StoreLst : BasePage
    {
        #region "Attributes"

        //BL.ADMIN.Department             departCode = new BL.ADMIN.Department();
        ...
        private readonly string moduleID = "2.9.13"; // ModuleId of [PC] because they happen before [MA]
        #endregion
        ...
        protected void Control_HeaderMenuBar()
        {
            ...
            ListPage1.CreateItems.Visible = (pagePermiss >= 3) ? ListPage1.CreateItems.Visible : false;
        }
        // End Added.
        ...
        //private string GetArrSONo()
        //{

        //    StringBuilder sb = new StringBuilder();


        //    GridView grdd = (GridView)ListPage1.FindControl("grd_BU");
