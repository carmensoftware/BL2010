...
{
    public partial class SummaryAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molSummaryPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolSummaryPopup");
            molSummaryPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", string.Format("SummaryAccountCode_Click('{0}','{1}')", DataBinder.Eval(e.Row.DataItem, "AccountCode"), DataBinder.Eval(e.Row.DataItem, "NameEng")));
