<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentDefaultCashAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentDefaultCashAccount" %>
...
<script type="text/javascript">
       ...
       function AccountCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl2_grd_PaymentCash__ctl2_txt_PaymentAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl2_grd_PaymentCash__ctl2_txt_PaymentAccount_Name').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl2_grd_PaymentCash__ctl2_MolPaymentDefaultCashAccountPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl2_grd_PaymentCash__ctl2_MolPaymentDefaultCashAccountPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
