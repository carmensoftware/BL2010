<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VendorCategory.ascx.cs" Inherits="BlueLedger.PL.UserControls.AP.VendorCategory" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function VendorCategoryCode_Click(vendor_CategoryCode,vendor_CategoryName)
        {
            window.document.getElementById('_ctl0_cph_Main_txt_Category').value           = vendor_CategoryCode;
            window.document.getElementById('_ctl0_cph_Main_txt_CategoryName').innerText   = vendor_CategoryName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolVendorCategoryPopup');
        }
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td>
                        <asp:Label ID="lbl_Title" runat="server" Text="Vendor - Select VendorCategory" Font-Bold="False"
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolVendorCategoryPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <asp:GridView ID="grd_Result" SkinID="GRD_NORMAL" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_VendorCategoryCode" runat="server" SkinID="LBL_NORMAL" Text="Vendor Code">
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_VendorCategoryCode" runat="server" SkinID="LBL_NORMAL"></asp:Label>
                                    <asp:Label ID="lbl_VendorName" runat="server" SkinID="LBL_NORMAL"></asp:Label>
                                </ItemTemplate>
