...
{
    public partial class PaymentCashAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentCashAccountPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentCashAccountPopup");
            molPaymentCashAccountPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", string.Format("PaymentCashAccountCode_Click('{0}','{1}')", DataBinder.Eval(e.Row.DataItem, "AccountCode"), DataBinder.Eval(e.Row.DataItem, "NameEng")));
