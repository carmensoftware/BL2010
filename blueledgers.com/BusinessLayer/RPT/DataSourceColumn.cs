...
namespace Blue.BL.RPT
{
    public class DataSourceColumn : DbHandler
    {
        ...
        {
            SelectCommand = "SELECT * FROM RPT.DataSourceColumn";
        ...
        public bool GetList(DataSet dsDataSourceColumn, int datasourceID, string connStr)
        {
            ...
            result = DbRetrieve("RPT.GetDataSourceColumnListByDataSourceID", dsDataSourceColumn, dbParams, TableName,
                connStr);
            return result;
        }
        ...
        public bool GetDataSourceColumnStructure(DataSet dsDataSourceColumn, string connStr)
        {
            ...
            // Get data
            result = DbRetrieveSchema("RPT.GetDataSourceColumnList", dsDataSourceColumn, null, TableName, connStr);
        ...
        public DataTable GetList(int dataSourceID, bool isJoinFieldData, string connStr)
        {
            ...
            return DbRead("RPT.GetDataSourceColumnListByDataSourceIDJoinField", dbParams, connStr);
        }
