<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentTransVendorBranch.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentTransVendorBranch" %>
...
<script type="text/javascript">
       ...
       function TransVendorBranchCode_Click(branchCode,branchName)
        {
            window.document.getElementById('_ctl0_cph_Main_txt_VTransBranchCode').value          = branchCode;
            window.document.getElementById('_ctl0_cph_Main_txt_VTransBranchName').innerText      = branchName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransVBranchPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransVBranchPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
