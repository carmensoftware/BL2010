...
{
    public partial class PaymentTransVendorBranch : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentTransVBranchPopup =
                (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentTransVBranchPopup");
            molPaymentTransVBranchPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", string.Format("TransVendorBranchCode_Click('{0}','{1}')", DataBinder.Eval(e.Row.DataItem, "BranchCode"), DataBinder.Eval(e.Row.DataItem, "BranchName")));
