<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentTransBranch.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentTransBranch" %>
...
<script type="text/javascript">
       ...
       function BranchCode_Click(branchCode,branchName)
        {
            window.document.getElementById('_ctl0_cph_Main_txt_TransBranchCode').value      = branchCode;
            window.document.getElementById('_ctl0_cph_Main_txt_TransBranchName').innerText  = branchName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransBranchPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransBranchPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
