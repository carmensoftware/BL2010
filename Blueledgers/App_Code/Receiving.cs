...
rc AS(
	SELECT
		...
		d.ProductCode,
		d.LocationCode,
		ISNULL(RecQty, 0) + ISNULL(FocQty, 0) as Qty,
...
SELECT
	...
	ProductCode,
	LocationCode,
	ROUND(Qty * Rate, app.DigitQty()),
	0,
	CASE WHEN Qty=0 THEN 0 ELSE ROUND(NetAmt/Qty, app.DigitAmt()) END,
	NetAmt,
	'RC',
	@CommittedDate
FROM
...
SELECT
	...
	ProductCode,
	LocationCode,
	ROUND((RecQty + ISNULL(FocQty,0)) * ISNULL(Rate, 1), @DigitQty) as Qty,
