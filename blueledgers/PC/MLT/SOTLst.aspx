<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="SOTLst.aspx.cs" Inherits="BlueLedger.PL.IN.MLT.SOTLst" %>
                ...
                <table border="0" cellpadding="1" cellspacing="0" width="100%">
                    <tr style="height: 40px;">
                        <td style="border-bottom: solid 5px #187EB8;">
                            <asp:Label ID="lbl_Title" runat="server" Font-S
                            ize="13pt" Font-Bold="true"></asp:Label>
                        </td>
        ...
        <tr>
            <td>            
                <uc1:ListPage2 ID="ListPage" runat="server" KeyFieldName="TmpNo" 
                    PageCode="[IN].[vStandardOrder]" Title="Standard Order List" 
                    EnableTheming="True" AllowViewCreate="False" DetailPageURL="SOT.aspx" 
                    EditPageURL="~/PC/MLT/SOTEdit.aspx"/>                    
            </td>
        </tr>
    </table>
</asp:Content>
