...
namespace BlueLedger.PL.Option.Admin.Interface.Sun
{
    public partial class AccountMapp : BasePage
    {
        ...
        private void Page_Retrieve()
        {
            ...
            {
                lbl_Warning.Text = "No store/location is available.";
            ...
            accountMapp.GetList(dsAccountCategory, cmb_Store.SelectedItem.Value.ToString(),
                cmb_Type.SelectedItem.Value.ToString(), LoginInfo.ConnStr, Blue.BL.Option.Admin.Interface.PostType.AP);
        ...
        protected void grd_AccountMapp_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    var lbl = (Label)e.Row.FindControl("lbl_ID");
                    lbl.Text = DataBinder.Eval(e.Row.DataItem, "ID").ToString(); ; 
                }

                // ID
                if (e.Row.FindControl("hid_ID") != null)
                {
                    var hid = (HiddenField)e.Row.FindControl("hid_ID");
                    hid.Value = DataBinder.Eval(e.Row.DataItem, "ID").ToString();
                }
                ...
                {
                    var lbl_ItemGroup = (Label)e.Row.FindControl("lbl_Category");
                    lbl_ItemGroup.Text = DataBinder.Eval(e.Row.DataItem, "CategoryCode").ToString() + " : " + DataBinder.Eval(e.Row.DataItem, "CategoryName").ToString();
                }

                // Sub-Category
                if (e.Row.FindControl("lbl_SubCategory") != null)
                {
                    var lbl_ItemGroup = (Label)e.Row.FindControl("lbl_SubCategory");
                    lbl_ItemGroup.Text = DataBinder.Eval(e.Row.DataItem, "SubCategoryCode").ToString() + " : " + DataBinder.Eval(e.Row.DataItem, "SubCategoryName").ToString();
                }
                ...
                if (e.Row.FindControl("lbl_ItemGroup") != null)
                {
                    ...
                    lbl_ItemGroup.Text = DataBinder.Eval(e.Row.DataItem, "ItemGroupCode").ToString() + " : " + DataBinder.Eval(e.Row.DataItem, "ItemGroupName").ToString();
                }
                ...
                if (e.Row.FindControl("hid_ItemGroupCode") != null)
                {
                    ...
                    hid_ItemGroupCode.Value = DataBinder.Eval(e.Row.DataItem, "ItemGroupCode").ToString();
                ...
                if (e.Row.FindControl("txt_A1") != null)
                {
                    ...
                    txt_A1.Text = DataBinder.Eval(e.Row.DataItem, "A1").ToString();
                ...
                if (e.Row.FindControl("txt_A2") != null)
                {
                    ...
                    txt_A2.Text = DataBinder.Eval(e.Row.DataItem, "A2").ToString();
                ...
                if (e.Row.FindControl("txt_A3") != null)
                {
                    ...
                    txt_A3.Text = DataBinder.Eval(e.Row.DataItem, "A3").ToString();
                ...
                if (e.Row.FindControl("txt_A4") != null)
                {
                    ...
                    txt_A4.Text = DataBinder.Eval(e.Row.DataItem, "A4").ToString();
                ...
                if (e.Row.FindControl("txt_A5") != null)
                {
                    ...
                    txt_A5.Text = DataBinder.Eval(e.Row.DataItem, "A5").ToString();
                ...
                if (e.Row.FindControl("txt_A6") != null)
                {
                    ...
                    txt_A6.Text = DataBinder.Eval(e.Row.DataItem, "A6").ToString();
                ...
                if (e.Row.FindControl("txt_A7") != null)
                {
                    ...
                    txt_A7.Text = DataBinder.Eval(e.Row.DataItem, "A7").ToString();
                ...
                if (e.Row.FindControl("txt_A8") != null)
                {
                    ...
                    txt_A8.Text = DataBinder.Eval(e.Row.DataItem, "A8").ToString();
                ...
                if (e.Row.FindControl("txt_A9") != null)
                {
                    ...
                    txt_A9.Text = DataBinder.Eval(e.Row.DataItem, "A9").ToString();
        ...
        private bool Save()
        {
            ...
            if (Page.IsValid)
            {
                ...
                //        // Add by mai 
                //        drAccMap["postType"] = Blue.BL.Option.Admin.Interface.PostType.AP.ToString();
                ...
                for (var i = 0; i <= grd_AccountMapp.Rows.Count - 1; i++)
                {
                    //var drAccMap = dsAccountMapp.Tables[accountMapp.TableName].NewRow();
                    var drAccMap = dsAccountCategory.Tables[accountMapp.TableName].Rows[i];

                    //drAccMap["ID"] = dsAccountCategory.Tables[accountMapp.TableName].Rows[i]["ID"];
                    //var hid_BusinessUnitCode = (HiddenField)grd_AccountMapp.Rows[i].FindControl("hid_BusinessUnitCode");
                    // drAccMap["BusinessUnitCode"] = hid_BusinessUnitCode.ToString();
                    //drAccMap["BusinessUnitCode"] = hid_BusinessUnitCode.ToString();
                    //drAccMap["StoreCode"] = dsAccountCategory.Tables[accountMapp.TableName].Rows[i]["LocationCode"].ToString();
                    //drAccMap["CategoryCode"] = System.DBNull.Value;
                    //drAccMap["SubCategoryCode"] = System.DBNull.Value;
                    //drAccMap["ItemGroupCode"] = dsAccountCategory.Tables[accountMapp.TableName].Rows[i]["ItemGroupCode"].ToString();


                    // A1
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A1") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A1");
                        drAccMap["A1"] = txt.Text.Trim();
                    }
                    // A2
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A2") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A2");
                        drAccMap["A2"] = txt.Text.Trim();
                    }
                    // A3
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A3") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A3");
                        drAccMap["A3"] = txt.Text.Trim();
                    }
                    // A4
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A4") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A4");
                        drAccMap["A4"] = txt.Text.Trim();
                    }
                    // A5
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A5") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A5");
                        drAccMap["A5"] = txt.Text.Trim();
                    }
                    // A6
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A6") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A6");
                        drAccMap["A6"] = txt.Text.Trim();
                    }
                    // A7
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A7") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A7");
                        drAccMap["A7"] = txt.Text.Trim();
                    }
                    // A8
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A8") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A8");
                        drAccMap["A8"] = txt.Text.Trim();
                    }
                    // A9
                    if (grd_AccountMapp.Rows[i].FindControl("txt_A9") != null)
                    {
                        var txt = (TextBox)grd_AccountMapp.Rows[i].FindControl("txt_A9");
                        drAccMap["A9"] = txt.Text.Trim();
                    }

                    drAccMap["PostType"] = "AP";
            ...
            var success = accountMapp.Save(dsAccountCategory, LoginInfo.ConnStr);

            if (success)
            {
                Label_Info.Text = "Data saved.";
                pop_Info.ShowOnPageLoad = true;
                return true;
