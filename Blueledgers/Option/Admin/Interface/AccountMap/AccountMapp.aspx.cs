...
namespace BlueLedger.PL.Option.Admin.Interface.AccountMap
{
    public partial class AccountMapp : BasePage
    {
        ...
        private DataTable _dtView
        {
            get
            {
                return (DataTable)Session["dtView"];
            }
            set
            {
                Session["dtView"] = value;
            }
        }

        private DataTable _dtAccountMapp
        {
            get
            {
                return (DataTable)Session["dtAccountMapp"];
            }
            set
            {
                Session["dtAccountMapp"] = value;
            }
        }
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _dtAccountMapp = (DataTable)Session["dtAccountMapp"];
            }
        ...
        {
            ExportToCsv(_dtView, _dtAccountMapp);
        }
        ...
        {
            int rowIndex = getRowIndexViewByID(_dtView, ddlViewName.SelectedValue.ToString());
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                #region Key Header
                if (_dtView.Rows[rowIndex]["DescKeyA1"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[6].Text = (string)_dtView.Rows[rowIndex]["DescKeyA1"];
                if (_dtView.Rows[rowIndex]["DescKeyA2"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[7].Text = (string)_dtView.Rows[rowIndex]["DescKeyA2"];
                if (_dtView.Rows[rowIndex]["DescKeyA3"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[8].Text = (string)_dtView.Rows[rowIndex]["DescKeyA3"];
                if (_dtView.Rows[rowIndex]["DescKeyA4"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[9].Text = (string)_dtView.Rows[rowIndex]["DescKeyA4"];
                if (_dtView.Rows[rowIndex]["DescKeyA5"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[10].Text = (string)_dtView.Rows[rowIndex]["DescKeyA5"];
                if (_dtView.Rows[rowIndex]["DescKeyA6"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[11].Text = (string)_dtView.Rows[rowIndex]["DescKeyA6"];
                if (_dtView.Rows[rowIndex]["DescKeyA7"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[12].Text = (string)_dtView.Rows[rowIndex]["DescKeyA7"];
                if (_dtView.Rows[rowIndex]["DescKeyA8"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[13].Text = (string)_dtView.Rows[rowIndex]["DescKeyA8"];
                if (_dtView.Rows[rowIndex]["DescKeyA9"] != DBNull.Value) gvAccountMap.HeaderRow.Cells[14].Text = (string)_dtView.Rows[rowIndex]["DescKeyA9"];
                #endregion
            ...
            DataRow dr = _dtView.Rows[rowIndex];
        ...
        protected void gvAccountMap_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            DataView sortedView = new DataView(_dtAccountMapp);
        ...
        {
            _dtView = config.DbExecuteQuery("SELECT * FROM [ADMIN].[AccountMappView] ORDER BY ViewName", null, LoginInfo.ConnStr);

            ddlViewName.DataSource = _dtView;
            ddlViewName.DataTextField = "ViewName";
            ddlViewName.DataValueField = "ID";
            ddlViewName.DataBind();
        }

        protected void SetGridView(DataTable dtView)
        {
        ...
        protected void SetAccountMappByView(DataTable dtView)
        {
            ...
            gvAccountMap.Columns[1].Visible = (bool)_dtView.Rows[rowIndex]["BusinessUnitCode"];
            gvAccountMap.Columns[2].Visible = (bool)_dtView.Rows[rowIndex]["StoreCode"];
            gvAccountMap.Columns[3].Visible = (bool)_dtView.Rows[rowIndex]["CategoryCode"];
            gvAccountMap.Columns[4].Visible = (bool)_dtView.Rows[rowIndex]["SubCategoryCode"];
            gvAccountMap.Columns[5].Visible = (bool)_dtView.Rows[rowIndex]["ItemGroupCode"];

            // Added on: 23/11/2017, For: New key field.
            gvAccountMap.Columns[6].Visible = (bool)_dtView.Rows[rowIndex]["KeyA1"];
            gvAccountMap.Columns[7].Visible = (bool)_dtView.Rows[rowIndex]["KeyA2"];
            gvAccountMap.Columns[8].Visible = (bool)_dtView.Rows[rowIndex]["KeyA3"];
            gvAccountMap.Columns[9].Visible = (bool)_dtView.Rows[rowIndex]["KeyA4"];
            gvAccountMap.Columns[10].Visible = (bool)_dtView.Rows[rowIndex]["KeyA5"];
            gvAccountMap.Columns[11].Visible = (bool)_dtView.Rows[rowIndex]["KeyA6"];
            gvAccountMap.Columns[12].Visible = (bool)_dtView.Rows[rowIndex]["KeyA7"];
            gvAccountMap.Columns[13].Visible = (bool)_dtView.Rows[rowIndex]["KeyA8"];
            gvAccountMap.Columns[14].Visible = (bool)_dtView.Rows[rowIndex]["KeyA9"];
            // End Added.
            ...
            // Label
            gvAccountMap.Columns[15].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A1"];
            gvAccountMap.Columns[17].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A2"];
            gvAccountMap.Columns[19].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A3"];
            gvAccountMap.Columns[21].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A4"];
            gvAccountMap.Columns[23].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A5"];
            gvAccountMap.Columns[25].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A6"];
            gvAccountMap.Columns[27].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A7"];
            gvAccountMap.Columns[29].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A8"];
            gvAccountMap.Columns[31].Visible = (isEditBarClick) ? false : (bool)_dtView.Rows[rowIndex]["A9"];

            // TextBox
            gvAccountMap.Columns[16].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A1"] : false;
            gvAccountMap.Columns[18].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A2"] : false;
            gvAccountMap.Columns[20].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A3"] : false;
            gvAccountMap.Columns[22].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A4"] : false;
            gvAccountMap.Columns[24].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A5"] : false;
            gvAccountMap.Columns[26].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A6"] : false;
            gvAccountMap.Columns[28].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A7"] : false;
            gvAccountMap.Columns[30].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A8"] : false;
            gvAccountMap.Columns[32].Visible = (isEditBarClick) ? (bool)_dtView.Rows[rowIndex]["A9"] : false;


            if (isEditViewClick)
            {
                cblView.Items[0].Selected = (bool)_dtView.Rows[rowIndex]["BusinessUnitCode"];
                cblView.Items[1].Selected = (bool)_dtView.Rows[rowIndex]["StoreCode"];
                cblView.Items[2].Selected = (bool)_dtView.Rows[rowIndex]["CategoryCode"];
                cblView.Items[3].Selected = (bool)_dtView.Rows[rowIndex]["SubCategoryCode"];
                cblView.Items[4].Selected = (bool)_dtView.Rows[rowIndex]["ItemGroupCode"];

                // Added on: 23/11/2017
                cblView_KeyA.Items.FindByValue("KeyA1").Selected = (bool)_dtView.Rows[rowIndex]["KeyA1"];
                cblView_KeyA.Items.FindByValue("KeyA2").Selected = (bool)_dtView.Rows[rowIndex]["KeyA2"];
                cblView_KeyA.Items.FindByValue("KeyA3").Selected = (bool)_dtView.Rows[rowIndex]["KeyA3"];
                cblView_KeyA.Items.FindByValue("KeyA4").Selected = (bool)_dtView.Rows[rowIndex]["KeyA4"];
                cblView_KeyA.Items.FindByValue("KeyA5").Selected = (bool)_dtView.Rows[rowIndex]["KeyA5"];
                cblView_KeyA.Items.FindByValue("KeyA6").Selected = (bool)_dtView.Rows[rowIndex]["KeyA6"];
                cblView_KeyA.Items.FindByValue("KeyA7").Selected = (bool)_dtView.Rows[rowIndex]["KeyA7"];
                cblView_KeyA.Items.FindByValue("KeyA8").Selected = (bool)_dtView.Rows[rowIndex]["KeyA8"];
                cblView_KeyA.Items.FindByValue("KeyA9").Selected = (bool)_dtView.Rows[rowIndex]["KeyA9"];
                // End Added.

                cblValue.Items[0].Selected = (bool)_dtView.Rows[rowIndex]["A1"];
                cblValue.Items[1].Selected = (bool)_dtView.Rows[rowIndex]["A2"];
                cblValue.Items[2].Selected = (bool)_dtView.Rows[rowIndex]["A3"];
                cblValue.Items[3].Selected = (bool)_dtView.Rows[rowIndex]["A4"];
                cblValue.Items[4].Selected = (bool)_dtView.Rows[rowIndex]["A5"];
                cblValue.Items[5].Selected = (bool)_dtView.Rows[rowIndex]["A6"];
                cblValue.Items[6].Selected = (bool)_dtView.Rows[rowIndex]["A7"];
                cblValue.Items[7].Selected = (bool)_dtView.Rows[rowIndex]["A8"];
                cblValue.Items[8].Selected = (bool)_dtView.Rows[rowIndex]["A9"];

                //If get DBNULL.Value then jump out.
                #region Key Description
                if (_dtView.Rows[rowIndex]["DescKeyA1"] != DBNull.Value) txtDescKeyA1.Text = (string)_dtView.Rows[rowIndex]["DescKeyA1"];
                if (_dtView.Rows[rowIndex]["DescKeyA2"] != DBNull.Value) txtDescKeyA2.Text = (string)_dtView.Rows[rowIndex]["DescKeyA2"];
                if (_dtView.Rows[rowIndex]["DescKeyA3"] != DBNull.Value) txtDescKeyA3.Text = (string)_dtView.Rows[rowIndex]["DescKeyA3"];
                if (_dtView.Rows[rowIndex]["DescKeyA4"] != DBNull.Value) txtDescKeyA4.Text = (string)_dtView.Rows[rowIndex]["DescKeyA4"];
                if (_dtView.Rows[rowIndex]["DescKeyA5"] != DBNull.Value) txtDescKeyA5.Text = (string)_dtView.Rows[rowIndex]["DescKeyA5"];
                if (_dtView.Rows[rowIndex]["DescKeyA6"] != DBNull.Value) txtDescKeyA6.Text = (string)_dtView.Rows[rowIndex]["DescKeyA6"];
                if (_dtView.Rows[rowIndex]["DescKeyA7"] != DBNull.Value) txtDescKeyA7.Text = (string)_dtView.Rows[rowIndex]["DescKeyA7"];
                if (_dtView.Rows[rowIndex]["DescKeyA8"] != DBNull.Value) txtDescKeyA8.Text = (string)_dtView.Rows[rowIndex]["DescKeyA8"];
                if (_dtView.Rows[rowIndex]["DescKeyA9"] != DBNull.Value) txtDescKeyA9.Text = (string)_dtView.Rows[rowIndex]["DescKeyA9"];
                #endregion
                #region Value description
                if (_dtView.Rows[rowIndex]["DescA1"] != DBNull.Value) txtDESCA1.Text = (string)_dtView.Rows[rowIndex]["DescA1"];
                if (_dtView.Rows[rowIndex]["DescA2"] != DBNull.Value) txtDESCA2.Text = (string)_dtView.Rows[rowIndex]["DescA2"];
                if (_dtView.Rows[rowIndex]["DescA3"] != DBNull.Value) txtDESCA3.Text = (string)_dtView.Rows[rowIndex]["DescA3"];
                if (_dtView.Rows[rowIndex]["DescA4"] != DBNull.Value) txtDESCA4.Text = (string)_dtView.Rows[rowIndex]["DescA4"];
                if (_dtView.Rows[rowIndex]["DescA5"] != DBNull.Value) txtDESCA5.Text = (string)_dtView.Rows[rowIndex]["DescA5"];
                if (_dtView.Rows[rowIndex]["DescA6"] != DBNull.Value) txtDESCA6.Text = (string)_dtView.Rows[rowIndex]["DescA6"];
                if (_dtView.Rows[rowIndex]["DescA7"] != DBNull.Value) txtDESCA7.Text = (string)_dtView.Rows[rowIndex]["DescA7"];
                if (_dtView.Rows[rowIndex]["DescA8"] != DBNull.Value) txtDESCA8.Text = (string)_dtView.Rows[rowIndex]["DescA8"];
                if (_dtView.Rows[rowIndex]["DescA9"] != DBNull.Value) txtDESCA9.Text = (string)_dtView.Rows[rowIndex]["DescA9"];
                #endregion


                #region Type
                Bind_DdlTxtType();
                if (_dtView.Rows[rowIndex]["TypeA1"] != DBNull.Value) ddlTxtType1.SelectedValue = _dtView.Rows[rowIndex]["TypeA1"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA2"] != DBNull.Value) ddlTxtType2.SelectedValue = _dtView.Rows[rowIndex]["TypeA2"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA3"] != DBNull.Value) ddlTxtType3.SelectedValue = _dtView.Rows[rowIndex]["TypeA3"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA4"] != DBNull.Value) ddlTxtType4.SelectedValue = _dtView.Rows[rowIndex]["TypeA4"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA5"] != DBNull.Value) ddlTxtType5.SelectedValue = _dtView.Rows[rowIndex]["TypeA5"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA6"] != DBNull.Value) ddlTxtType6.SelectedValue = _dtView.Rows[rowIndex]["TypeA6"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA7"] != DBNull.Value) ddlTxtType7.SelectedValue = _dtView.Rows[rowIndex]["TypeA7"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA8"] != DBNull.Value) ddlTxtType8.SelectedValue = _dtView.Rows[rowIndex]["TypeA8"].ToString();
                if (_dtView.Rows[rowIndex]["TypeA9"] != DBNull.Value) ddlTxtType9.SelectedValue = _dtView.Rows[rowIndex]["TypeA9"].ToString();
                #endregion


                Bind_ddlPostType();

                if (ddlPostType.Items.FindByText(_dtView.Rows[rowIndex]["PostType"].ToString()) != null)
                    ddlPostType.SelectedValue = (string)_dtView.Rows[rowIndex]["PostType"];
        ...
        protected void Bind_AccountMapp()
        {
            ...
            try
            {
                ...
                strsql += "where PostType = '" + (string)_dtView.Rows[rowIndex]["PostType"] + "'";
        ...
        {
            int rowIndex = -1;
            for (int i = 0; i < _dtAccountMapp.Rows.Count; i++)
            {
                if (_dtAccountMapp.Rows[i]["ID"].ToString() == id)
                {
                    rowIndex = i;
                    break;
                }
        ...
        protected void saveToDatatable()
        {
            ...
            for (int i = rowIndexStart; i < rowIndexStart + gvAccountMap.Rows.Count; i++)
            {
                ...
                if (!gvAccountMap.Columns[6].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A1"] = ddlA1.Visible ? ddlA1.SelectedValue.ToString() : txtA1.Text;
                if (!gvAccountMap.Columns[7].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A2"] = ddlA2.Visible ? ddlA2.SelectedValue.ToString() : txtA2.Text;
                if (!gvAccountMap.Columns[8].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A3"] = ddlA3.Visible ? ddlA3.SelectedValue.ToString() : txtA3.Text;
                if (!gvAccountMap.Columns[9].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A4"] = ddlA4.Visible ? ddlA4.SelectedValue.ToString() : txtA4.Text;
                if (!gvAccountMap.Columns[10].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A5"] = ddlA5.Visible ? ddlA5.SelectedValue.ToString() : txtA5.Text;
                if (!gvAccountMap.Columns[11].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A6"] = ddlA6.Visible ? ddlA6.SelectedValue.ToString() : txtA6.Text;
                if (!gvAccountMap.Columns[12].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A7"] = ddlA7.Visible ? ddlA7.SelectedValue.ToString() : txtA7.Text;
                if (!gvAccountMap.Columns[13].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A8"] = ddlA8.Visible ? ddlA8.SelectedValue.ToString() : txtA8.Text;
                if (!gvAccountMap.Columns[14].Visible)
                    _dtAccountMapp.Rows[rowIndex]["A9"] = ddlA9.Visible ? ddlA9.SelectedValue.ToString() : txtA9.Text;
                r++;
            }
        }
            ...
            try
            {
                using (System.IO.TextReader tr = File.OpenText(Server.MapPath(fileName)))
                {
                    ...
                    while ((line = tr.ReadLine()) != null)
                    {
                        ...
                        if (lineIndex == 0)
                        { rowViewIndex = getRowIndexViewByID(_dtView, items[1].ToString()); }
                        else if (lineIndex == 1)
                        {
        ...
        protected void saveImportToDatabase(int rowViewIndex, DataTable dtImportFile)
        {
            ...
            try
            {
                ...
                foreach (DataRow row in dtImportFile.Rows)
                {
                    string strSql = "update [Admin].accountMapp ";
                    strSql += "Set ";
                    if ((bool)_dtView.Rows[rowViewIndex]["A1"]) { strSql += "A1=@A1,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A2"]) { strSql += "A2=@A2,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A3"]) { strSql += "A3=@A3,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A4"]) { strSql += "A4=@A4,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A5"]) { strSql += "A5=@A5,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A6"]) { strSql += "A6=@A6,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A7"]) { strSql += "A7=@A7,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A8"]) { strSql += "A8=@A8,"; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A9"]) { strSql += "A9=@A9,"; }
                    ...
                    int col = 1;
                    if ((bool)_dtView.Rows[rowViewIndex]["BusinessUnitCode"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["StoreCode"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["CategoryCode"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["SubCategoryCode"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["ItemGroupCode"]) { col++; }

                    // Added on: 23/11/2017, For: New key field
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA1"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA2"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA3"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA4"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA5"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA6"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA7"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA8"]) { col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["KeyA9"]) { col++; }
                    // End Added.

                    if ((bool)_dtView.Rows[rowViewIndex]["A1"]) { cmd.Parameters.AddWithValue("@A1", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A2"]) { cmd.Parameters.AddWithValue("@A2", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A3"]) { cmd.Parameters.AddWithValue("@A3", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A4"]) { cmd.Parameters.AddWithValue("@A4", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A5"]) { cmd.Parameters.AddWithValue("@A5", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A6"]) { cmd.Parameters.AddWithValue("@A6", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A7"]) { cmd.Parameters.AddWithValue("@A7", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A8"]) { cmd.Parameters.AddWithValue("@A8", row[col]); col++; }
                    if ((bool)_dtView.Rows[rowViewIndex]["A9"]) { cmd.Parameters.AddWithValue("@A9", row[col]); col++; }
                    cmd.ExecuteNonQuery();
                }
            }
            catch
        ...
        protected void BarSaveOnClick()
        {
            ...
            int rowIndex = getRowIndexViewByID(_dtView, ddlViewName.SelectedValue.ToString());
            string postType = (string)_dtView.Rows[rowIndex]["PostType"];
            DataTable dtAccountMapp = (DataTable)Session["dtAccountMapp"];
            try
            {
                cnn.Open();
            ...
            try
            {
                ...
                if ((string)Session["IsEditViewName"] == "1")
                {
                    ...
                    strSql = string.Format(@"update [ADMIN].[AccountMappView] 
                        ...
                        where ID= '{0}'", _dtView.Rows[rowIndex]["ID"]);
                }
        ...
        private void GetApiData()
        {
            ...
            if (values != string.Empty)
            {
                ...
                if (type.ToLower() == "api")
                {
                    ...
                    string host = keys.Value("host");
                    string token = keys.Value("auth");

                    var api = new CarmenApi(host, token);

                    var accountCodes = api.GetAccountCode();


                    var departments = api.GetDepartment();
