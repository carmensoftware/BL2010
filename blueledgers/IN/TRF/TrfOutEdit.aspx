<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrfOutEdit.aspx.cs" Inherits="BlueLedger.PL.IN.TRF.TrfOutEdit"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cph_Main">
        ...
        <tr style="background-color: #4d4d4d; height: 17px;">
            ...
            <td align="right">
                <table border="0" cellpadding="1" cellspacing="0">
                    <tr>
                        <td>
                            <dx:ASPxButton ID="btn_Save" runat="server" BackColor="Transparent" Height="10px"
                                Border-BorderStyle="None" Width="42px" OnClick="btn_Save_Click" ToolTip="Save">
                        ...
                        <td>
                            <dx:ASPxButton ID="btn_Commit" runat="server" BackColor="Transparent" OnClick="btn_Commit_Click"
                                Border-BorderStyle="None" ToolTip="Commit" Width="51px" Height="16px">
    ...
    <table border="0" cellpadding="0" cellspacing="3" width="100%" class="TABLE_HD">
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                <asp:Label ID="lbl_ToLocationName" runat="server" SkinID="LBL_NR"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label20" runat="server" Text="Delivery Date:" SkinID="LBL_HD"></asp:Label>
            </td>
            <td>
                <dx:ASPxDateEdit ID="de_DeliveryDate" runat="server" SkinID="LBL_NR" Width="100px">
                </dx:ASPxDateEdit>
            </td>
            <td>
    ...
    <table width="100%" border="0" cellpadding="1" cellspacing="0">
        <tr style="background-color: #4d4d4d" align="right">
            <td style="background-color: #4d4d4d; padding-left: 10px; width: 979px;" align="left">
                <asp:Label ID="Label27" runat="server" Text="Transfer Out Detail" SkinID="LBL_HD_WHITE"></asp:Label>
            </td>
            <td>
                <dx:ASPxButton ID="btn_Create" runat="server" BackColor="Transparent" Height="16px"
                    Border-BorderStyle="None" Width="49px" OnClick="btn_Create_Click">
            ...
            <td>
                <dx:ASPxButton ID="btn_Delete" runat="server" BackColor="Transparent" Height="16px"
                    Border-BorderStyle="None" Width="47px" OnClick="btn_Delete_Click">
    ...
    <asp:GridView ID="grd_TrfOutEdit" runat="server" SkinID="GRD_V1" AutoGenerateColumns="False"
        Width="100%" EmptyDataText="No Data to Display" OnRowCancelingEdit="grd_TrfOutEdit_RowCancelingEdit"
        OnRowDataBound="grd_TrfOutEdit_RowDataBound" OnRowEditing="grd_TrfOutEdit_RowEditing"
        OnRowUpdating="grd_TrfOutEdit_RowUpdating">
        <Columns>
            <asp:TemplateField>
                <HeaderTemplate>
                    ...
                    <table border="0" cellpadding="0" cellspacing="3" width="100%">
                        <tr align="left">
                            ...
                            <td width="13%" align="right">
                                <asp:Label ID="Label25" runat="server" Text="Qty Allocated" SkinID="LBL_HD_W"></asp:Label>
                            </td>
                            <td width="13%" align="right">
                                <asp:Label ID="Label26" runat="server" Text="Qty Out" SkinID="LBL_HD_W"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </HeaderTemplate>
                <ItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="3" width="100%">
                        <tr>
                            ...
                            <td width="13%" align="right">
                                <asp:Label ID="lbl_QtyTrOut" runat="server" SkinID="LBL_NR_GRD"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
                <EditItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="3" width="100%">
                        <tr>
                            ...
                            <td width="13%" align="right">
                                <%--<dx:ASPxTextBox ID="txt_QtyTrOut" runat="server" MaxLength="29" SkinID="TXT_V1">
                                </dx:ASPxTextBox>--%>
                                <asp:TextBox ID="txt_QtyTrOut" runat="server" MaxLength="29" SkinID="TXT_NUM_V1" Width="95%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        <td><asp:Label ID="Label4" Text="Comment" runat="server" SkinID="LBL_NR_GRD"></asp:Label></td>
                        
                        </tr>
                        <tr>
                        <td colspan="4">
                        <asp:TextBox ID="txt_Comment" runat="server" Width="99%" TextMode="MultiLine" SkinID="TXT_V1"></asp:TextBox>
                        </td>
                        </tr>
                    </table>
                    </ItemTemplate>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="1" width="100%" style="padding-left: 10px">
                                            <tr>
                                                ...
                                                <td style="width: 30%; padding-top: 10px;" align="left">
                                                    <asp:Label ID="Label29" runat="server" Text="Qty Out:" SkinID="LBL_HD"></asp:Label>
                                                </td>
                                                <td width="20%">
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 10px;" colspan="4">
                                                    <asp:TextBox ID="txt_Comment" runat="server" Width="100%" TextMode="MultiLine" SkinID="TXT_V1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </dx:ContentControl>
                    ...
                    <tr>
                        <td align="right">
                            <%--<dx:ASPxButton ID="btn_ComfiremDelete" CausesValidation="false" runat="server" Text="Yes"
                                SkinID="BTN_N1" OnClick="btn_ComfiremDelete_Click">
                            </dx:ASPxButton>--%>
                            <asp:Button ID="btn_ComfiremDelete" runat="server" Text="Yes" Width="50px" SkinID="BTN_V1"
                                OnClick="btn_ComfiremDelete_Click" Height="26px" />
                        </td>
                        <td align="left">
