<%@ Page Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    EnableEventValidation="true" CodeFile="RoleList.aspx.cs" Inherits="BlueLedger.PL.Option.Admin.Security.Role.RoleList" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="gvRoleList" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Description" DataField="RoleDesc" ItemStyle-CssClass="space20"
                        HeaderStyle-CssClass="space20">
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td align="center" colspan="2" height="50px">
                                    <asp:Label ID="Label1" runat="server" Text="<%$ Resources:Option_Admin_Security_Role_Role, MsgWarning %>"
