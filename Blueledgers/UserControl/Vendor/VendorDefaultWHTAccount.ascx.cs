...
{
    public partial class VendorDefaultWHTAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolVendorDefaultWHTAccountPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolVendorDefaultWHTAccountPoup");
            MolVendorDefaultWHTAccountPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "VendorDefaultWHTAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode").ToString() +
