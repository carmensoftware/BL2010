<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecCreateManual.aspx.cs" Inherits="BlueLedger.PL.IN.REC.PcRecRecCreateManual" MasterPageFile="~/Master/In/SkinDefault.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Main" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="btn_Back" runat="server" OnClick="btn_Back_Click" BackColor="Transparent" Height="16px" Width="42px" ToolTip="Back" HorizontalAlign="Right"
                                            ...
                                            <Border BorderStyle="None" />
                                            <ClientSideEvents Click="function(s,e){e.isValid=true;}" />
                                        </dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
                ...
                <div>
                    <table border="0" cellpadding="1" cellspacing="0" width="100%" class="TABLE_HD" style="margin: auto;">
                        <tr>
                            ...
                            <!-- C8 -->
                            <td style="width: 15%;">
                                <dx:ASPxComboBox ID="cmb_DeliPoint" runat="server" Width="98%" Font-Names="Arial" Font-Size="8pt" ForeColor="#4D4D4D" ValueType="System.String" ValueField="DptCode"
                                    TextField="Name" TextFormatString="{0} : {1}" IncrementalFilteringMode="Contains" DisplayFormatString="{0} : {1}" OnItemsRequestedByFilterCondition="cmb_DeliPoint_OnItemsRequestedByFilterCondition_SQL"
                                    OnItemRequestedByValue="cmb_DeliPoint_OnItemRequestedByValue_SQL">
                                    <Columns>
                                        <dx:ListBoxColumn Caption="Code" FieldName="DptCode" Width="25" />
                                        <dx:ListBoxColumn Caption="Name" FieldName="Name" Width="380" />
                                    </Columns>
                                    <ValidationSettings Display="Dynamic">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                        ...
                        <tr>
                            ...
                            <!-- C4 -->
                            <td>
                                <asp:TextBox ID="txt_InvNo" runat="server" MaxLength="30" SkinID="TXT_V1" Height="17px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="txt_InvNoReq" runat="server" ControlToValidate="txt_InvNo" ErrorMessage="*"> 
                            ...
                            <td colspan="5">
                                <table border="0" cellpadding="1" cellspacing="0" width="100%">
                                    <tr>
                                        <td>
                                            <dx:ASPxComboBox ID="ddl_Vendor" runat="server" Width="310" Font-Names="Arial" Font-Size="8pt" ForeColor="#4D4D4D" ValueField="VendorCode" ValueType="System.String"
                                                TextField="Name" TextFormatString="{0} : {1}" EnableCallbackMode="true" CallbackPageSize="10" IncrementalFilteringMode="Contains" OnItemsRequestedByFilterCondition="ddl_Vendor_OnItemsRequestedByFilterCondition_SQL"
                                                OnItemRequestedByValue="ddl_Vendor_OnItemRequestedByValue_SQL" OnSelectedIndexChanged="ddl_Vendor_SelectedIndexChanged">
                                                <Columns>
                                                    <dx:ListBoxColumn Caption="Code" FieldName="VendorCode" Width="65" />
                                                    <dx:ListBoxColumn Caption="Name" FieldName="Name" Width="380" />
                                                </Columns>
                                                <ValidationSettings Display="Dynamic">
                                                    <ErrorFrameStyle ImageSpacing="4px">
                        ...
                        <tr>
                            <!-- C1 -->
                            <td>
                                <asp:Label ID="lbl_Location_Nm" runat="server" Text="<%$ Resources:PC_REC_RecEdit, lbl_Location_Nm %>" SkinID="LBL_HD"></asp:Label>
                            </td>
                            <!-- C2-C4 -->
                            <td colspan="3">
                                <dx:ASPxComboBox ID="ddl_Location_Stamp" runat="server" Width="380px" ShowShadow="False" ValueField="LocationCode" TextField="LocationName" TextFormatString="{0} : {1}"
                                    OnLoad="ddl_Location_Stamp_Load" OnSelectedIndexChanged="ddl_Location_Stamp_OnSelectedIndexChanged" Font-Names="Arial" Font-Size="8pt" ForeColor="#4D4D4D"
                                    CallbackPageSize="10" OnItemsRequestedByFilterCondition="ddl_Location_Stamp_OnItemsRequestedByFilterCondition_SQL" OnItemRequestedByValue="ddl_Location_Stamp_OnItemRequestedByValue_SQL"
                                    EnableCallbackMode="true" DropDownStyle="DropDown" IncrementalFilteringMode="Contains" Style="margin-bottom: 0px">
                                    <Columns>
                                        <dx:ListBoxColumn Caption="Code" FieldName="LocationCode" Width="80" />
                                        <dx:ListBoxColumn Caption="Name" FieldName="LocationName" Width="380" />
                                    </Columns>
                                    <ValidationSettings Display="Dynamic">
                                        <ErrorFrameStyle ImageSpacing="4px">
                                            <ErrorTextPaddings PaddingLeft="4px" />
                            ...
                            <!-- C8-C10 -->
                            <td colspan="3">
                                <%--/* Modified on: 17/08/2017, By: Fon, For: editable currency content. */--%>
                                <table border="0" cellpadding="1" cellspacing="0">
                                    <tr>
                                        <td>
                                            <%--<dx:ASPxComboBox ID="ddl_Currency" runat="server" ValueType="System.String" Width="98%"
                                                AutoPostBack="True" Font-Names="Arial" Font-Size="8pt" ForeColor="#4D4D4D" IncrementalFilteringMode="Contains"
                                                Visible="false">
                                                <ValidationSettings Display="Dynamic">
                                                    <ErrorFrameStyle ImageSpacing="4px">
                                                        <ErrorTextPaddings PaddingLeft="4px" />
                                        ...
                                        <td style="width: 100px;">
                                            ...
                                            <asp:TextBox ID="txt_ExRateAu" runat="server" AutoPostBack="true" Width="75px" SkinID="TXT_NUM_V1" Visible="true" OnTextChanged="txt_ExRateAu_TextChanged"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <!-- C2-C10 -->
                            <td colspan="9">
                                <asp:TextBox ID="txt_Desc" runat="server" Width="60%" Height="17px" SkinID="TXT_V1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="left">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td align="right">
                            ...
                            <asp:Button ID="btn_AddPo" runat="server" Text="<%$ Resources:PC_REC_RecEdit, btn_AddPo %>" SkinID="BTN_V1" Visible="false" Width="80px" OnClick="btn_AddPo_Click" />
                        </td>
                    </tr>
                </table>
                <div style="overflow: auto; width: 100%;">
                    <asp:UpdatePanel ID="UpdatePanelDetail" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grd_RecEdit" runat="server" AutoGenerateColumns="False" EmptyDataText="No Data to Display" EnableModelValidation="True" SkinID="GRD_V1"
                                ...
                                OnRowUpdating="grd_RecEdit_RowUpdating" DataKeyNames="RecNo,RecDtNo" OnRowDeleting="grd_RecEdit_RowDeleting">
                                <Columns>
                                    <asp:TemplateField>
                                            ...
                                            <table border="0" cellpadding="3" cellspacing="0" width="100%" style="margin: auto;">
                                                <tr>
                                                    ...
                                                    <td width="18%" align="left" style="padding-right: 5px;">
                                                        <asp:Label ID="lbl_Product_Nm" runat="server" Text="<%$ Resources:PC_REC_RecEdit, lbl_Product_Nm %>" SkinID="LBL_HD_W" Width="150px" />
                                                    </td>
                                                    <td width="5%" align="right" style="padding-right: 5px;">
                                                        <%--50px--%>
                                                        <%--<asp:Label ID="lbl_Order_Nm" runat="server" Text="<%$ Resources:PC_REC_RecEdit, lbl_Order_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>--%><%-- Width="50px"--%>
                                                    </td>
                                                    ...
                                                    <td width="10%">
                                                        <asp:Label ID="lbl_ExpiryDate_Nm" runat="server" Text="Expiry Date" SkinID="LBL_NR_GRD" Width="100px"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Panel ID="p_Item" runat="server" Width="100%">
                                                <table border="0" cellpadding="3" cellspacing="0" width="100%" style="margin: auto;">
                                                    <tr>
                                                        <%-- Product --%>
                                                        <td width="18%" align="left" style="padding-right: 5px; white-space: nowrap; overflow: hidden">
                                                            <%--300px--%>
                                                            <asp:Label ID="lbl_ProductCode" runat="server" SkinID="LBL_NR_GRD" Width="150px"></asp:Label>
                                                            <dx:ASPxComboBox ID="ddl_Product" runat="server" AutoPostBack="false" CallbackPageSize="10" OnItemsRequestedByFilterCondition="ddl_ProductCode_OnItemsRequestedByFilterCondition_SQL"
                                                                ...
                                                                TextFormatString="{0} : {1} : {2}" TextField="ProductDesc1" ValueType="System.String" Width="95%" IncrementalFilteringMode="Contains" ValueField="ProductCode"
                                                                ReadOnly="true">
                                                                <Columns>
                                                        ...
                                                        <td width="5%" align="left">
                                                            <%--50px--%>
                                                            <asp:Label ID="lbl_Unit" runat="server" SkinID="LBL_NR_GRD" Visible="False"></asp:Label>
                                                        </td>
                                                        <td width="7%" align="right" style="padding-right: 5px;">
                                                            <%--50px--%>
                                            ...
                                            <table border="0" cellpadding="3" cellspacing="0" width="100%" style="margin: auto;">
                                                <tr>
                                                    ...
                                                    <td width="5%" style="padding-right: 5px;">
                                                        <%--50px--%>
                                                        <asp:Label ID="lbl_Unit" runat="server" SkinID="LBL_NR_GRD" Visible="False"></asp:Label><%-- Width="50px"--%>
                                                    </td>
                                                    <td width="7%" align="right" style="padding-right: 5px;">
                                                        <%--50px--%>
                                    ...
                                    <asp:TemplateField HeaderStyle-Width="0%">
                                        ...
                                        <EditItemTemplate>
                                            <tr id="TR_Summmary" runat="server" style="margin: auto;">
                                                <%--display: block;--%>
                                                <td colspan="5" style="padding-left: 10px; padding-right: 0px">
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: auto;">
                                                        <tr>
                                                                ...
                                                                <table border="0" cellpadding="3" cellspacing="0" class="TABLE_HD" width="100%" style="margin: auto;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="TD_LINE_GRD" style="width: 15%;">
                                                                            <asp:TextBox ID="txt_CurrNetAmt" runat="server" SkinID="TXT_NUM_V1" Height="17px" Width="100%" AutoPostBack="True" Enabled="false"></asp:TextBox>
                                                                        </td>
                                                                        ...
                                                                        <td class="TD_LINE_GRD" align="right" style="width: 15%">
                                                                            <asp:TextBox ID="txt_NetAmt" runat="server" SkinID="TXT_NUM_V1" Height="17px" Width="100%" AutoPostBack="True" OnTextChanged="txt_NetAmt_TextChanged" Enabled="false"></asp:TextBox>
                                                                        </td>
                                                                        <%--<td class="TD_LINE_GRD" align="center" style="width: 7%;">
                                                                            <asp:Label ID="lbl_NetAcc_Edit_Nm" runat="server" SkinID="LBL_HD_GRD" Text="<%$ Resources:PC_REC_RecEdit, lbl_NetAcc_Edit_Nm %>"></asp:Label>
                                                                        </td>
                                                                        <td class="TD_LINE_GRD" style="width: 15%;">
                                                                            <dx:ASPxComboBox ID="ddl_NetDrAcc" runat="server" Width="50%" DropDownStyle="DropDown"
                                                                                AutoPostBack="true" TextChanged="ddl_NetDrAcc_TextChanged">
                                                                            </dx:ASPxComboBox>--%>
                                                                        <%--<asp:RequiredFieldValidator ID="txt_NetDrAccReq" runat="server" ControlToValidate="ddl_NetDrAcc"
                                                                                ErrorMessage="*"> 
                                                                            </asp:RequiredFieldValidator>--%>
                                                                        <%--</td>--%>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txt_DiscAmt" runat="server" SkinID="TXT_NUM_V1" Height="17px" Width="100%" AutoPostBack="True" OnTextChanged="txt_DiscAmt_TextChanged"></asp:TextBox>
                                                                            <asp:RequiredFieldValidator ID="txt_DiscAmtReq" runat="server" ControlToValidate="txt_DiscAmt" ErrorMessage="*" Enabled="false"> 
                                                                            </asp:RequiredFieldValidator>
                                                                        </td>
                                                                        <%--<td colspan="2">
                                                                        </td>--%>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="TD_LINE_GRD">
                                                                            <asp:TextBox ID="txt_TaxAmt" runat="server" SkinID="TXT_NUM_V1" Height="17px" Width="100%" AutoPostBack="True" OnTextChanged="txt_TaxAmt_TextChanged"></asp:TextBox>
                                                                        </td>
                                                                        <%--<td class="TD_LINE_GRD" align="center">
                                                                            <asp:Label ID="lbl_TaxAcc_Edit_Nm" runat="server" SkinID="LBL_HD_GRD" Text="<%$ Resources:PC_REC_RecEdit, lbl_TaxAcc_Edit_Nm %>"></asp:Label>
                                                                        </td>
                                                                        <td class="TD_LINE_GRD">
                                                                            <dx:ASPxComboBox ID="ddl_TaxDrAcc" runat="server" Width="50%" DropDownStyle="DropDown">
                                                                            </dx:ASPxComboBox>
                                                                            <%--<asp:RequiredFieldValidator ID="txt_TaxDrAccReq" runat="server" ControlToValidate="ddl_TaxDrAcc"
                                                                                ErrorMessage="*"> 
                                                                            </asp:RequiredFieldValidator>--%>
                                                                        <%--</td>--%>
                                                                    </tr>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btn_AddItem" EventName="Click" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
            </div>
            ...
            <dx:ASPxPopupControl ID="pop_ConfrimDelete" ClientInstanceName="pop_ConfrimDelete" runat="server" Width="300px" CloseAction="CloseButton" HeaderText="<%$ Resources:PC_REC_RecEdit, Confirm %>"
                Modal="True" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False">
                <ContentStyle VerticalAlign="Top">
                </ContentStyle>
                <ContentCollection>
                    <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Button ID="btn_ConfrimDelete" runat="server" Text="<%$ Resources:PC_REC_RecEdit, btn_ConfrimDelete %>" Width="50px" OnClick="btn_ConfrimDelete_Click"
                                        SkinID="BTN_V1" />
                                </td>
                                <td align="left">
    ...
    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="UpdateProgress1" PopupControlID="UpdateProgress1" BackgroundCssClass="POPUP_BG"
        ...
        <ProgressTemplate>
            <div class="fix-layout" style="border-style: solid; border-width: 1px; border-color: #0071BD; background-color: #FFFFFF; width: 120px; height: 60px">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 120px; height: 60px">
                    <tr>
                        <td align="center">
                            <asp:Image ID="img_Loading12" runat="server" ImageUrl="~/App_Themes/Default/Images/master/in/Default/ajax-loader.gif" EnableViewState="False" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
