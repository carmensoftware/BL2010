<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SummaryAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.SummaryAccount" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
        function SummaryAccountCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_grd_Summary__ctl2_txt_GainLossAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_grd_Summary__ctl2_txt_GainLossAccountName').innerText   = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_grd_Summary__ctl2_MolSummaryPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_grd_Summary__ctl2_MolSummaryPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
