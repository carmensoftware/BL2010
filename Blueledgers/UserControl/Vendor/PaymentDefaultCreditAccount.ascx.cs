...
{
    public partial class PaymentDefaultCreditAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentCreditAccountPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentCreditAccountPoup");
            MolPaymentCreditAccountPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "CreditAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode").ToString() +
