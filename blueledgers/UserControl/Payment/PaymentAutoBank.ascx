<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentAutoBank.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentAutoBank" %>
...
<script type="text/javascript">
       ...
       {
            window.document.getElementById('_ctl0_cph_Main_txt_AutoBankCode').value      = accountCode;
            window.document.getElementById('_ctl0_cph_Main_txt_AutoBankName').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentAutoBankPopup');
       }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentAutoBankPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
