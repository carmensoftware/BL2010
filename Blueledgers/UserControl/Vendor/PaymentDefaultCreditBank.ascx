<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentDefaultCreditBank.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentDefaultCreditBank" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function CreditBankCode_Click(accountCode,accountName)
       {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl4_grd_PaymentCredit__ctl2_txt_CreditBankCode').value      = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl4_grd_PaymentCredit__ctl2_txt_CreditBankName').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl4_grd_PaymentCredit__ctl2_MolPaymentCreditBankPopup');
       }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl4_grd_PaymentCredit__ctl2_MolPaymentCreditBankPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
