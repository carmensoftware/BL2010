...
{
    public partial class PaymentDefaultTransVendorBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentTransVendorBankPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentTransVendorBankPoup");
            MolPaymentTransVendorBankPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "TransVendorBankCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BankCode").ToString() +
