...
namespace Blue.BL.Report
{
    public class DataSource : DbHandler
    {
        ...
        public DataSource()
        {
            SelectCommand = "SELECT * FROM Report.DataSource";
        ...
        public bool GetByReportID(DataSet dsDataSource, int reportID, string connStr)
        {
            ...
            return DbRetrieve("Report.GetDataSourceByReportID", dsDataSource, dbParams, TableName, connStr);
        }
        ...
        public string GetSourceByReportID(int reportID, string connStr)
        {
            ...
            DbRetrieve("Report.GetDataSourceByReportID", dsTmp, dbParams, TableName, connStr);
        ...
        {
            var result = false;
            result = DbRetrieve("Report.GetDataSourceList", dsDataSource, null, TableName, connStr);
            return result;
        }
        ...
        public bool Get(DataSet dsDataSource, int dataSourceID, string connStr)
        {
            ...
            result = DbRetrieve("Report.GetDataSourceListByDataSourceID", dsDataSource, dbParams, TableName, connStr);
            return result;
        }
        ...
        {
            return DbRead("Report.GetDataSourceListByActive", null, connStr);
        }
        ...
        public int GetDataSourceMaxID(string connStr)
        {
            ...
            // Get data
            result = DbReadScalar("Report.GetDataSourceMaxID", null, connStr);
        ...
        public bool GetDataSourceStructure(DataSet dsDataSource, string connStr)
        {
            ...
            // Get data
            result = DbRetrieveSchema("Report.GetDataSourceList", dsDataSource, null, TableName, connStr);
