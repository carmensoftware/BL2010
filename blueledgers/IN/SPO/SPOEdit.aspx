<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="SPOEdit.aspx.cs" Inherits="BlueLedger.PL.IN.SPO.SPOEdit" %>
        ...
        <tr>
            <td align="left">
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Spoil/Damage#" Font-Bold="true"></asp:Label></td><td>
                    ...
                    <table border = "0" cellpadding = "1" cellspacing = "5">
                        <tr>
                            ...
                            <asp:TextBox ID="txt_Comment" runat="server" Width = "368px"></asp:TextBox></td>
                        </tr>
                    </table><br />
