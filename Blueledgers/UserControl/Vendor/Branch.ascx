<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Branch.ascx.cs" Inherits="BlueLedger.PL.UserControls.AP.Branch" %>
...
<script type="text/javascript">
       ...
       function BranchCode_Click(branchCode,branchName)
        {
            window.document.getElementById('_ctl0_cph_Main_grd_BankAccount__ctl2_txt_BranchCode').value  = branchCode;
            window.document.getElementById('_ctl0_cph_Main_grd_BankAccount__ctl2_txt_Branch').innerText  = branchName;
            ModalPoupExtenderHide('_ctl0_cph_Main_grd_BankAccount__ctl2_MolBranchPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_grd_BankAccount__ctl2_MolBranchPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
