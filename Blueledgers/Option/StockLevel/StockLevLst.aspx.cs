...
{
    public partial class StockLevLst : BasePage
    {
        #region "Attributes"

        private DataSet dsStoreLct = new DataSet();
        private DataSet dsprodcat = new DataSet();
        private DataSet dsstockLev = new DataSet();
        ...
        private Blue.BL.Option.Inventory.Season season = new Blue.BL.Option.Inventory.Season();
        private Blue.BL.Option.Inventory.StockLev stockLev = new Blue.BL.Option.Inventory.StockLev();
        ...
        //    //    {
        //    //        if (tv_Product.Nodes[i].Selected == true)
        //    //        {
        //    //            if (tv_Product.Nodes[i].ChildNodes[j].Selected == true)
        //    //            {
        //    //                for (int m = 0; m < tv_Product.Nodes[i].ChildNodes[j].ChildNodes.Count; m++)
        //    //                {
        //    //                    if (tv_Product.Nodes[i].ChildNodes[j].ChildNodes[m].Selected == true)
        //    //                    {
        //    //                        int x = tv_Product.Nodes[i].ChildNodes[j].ChildNodes[m].ToString().IndexOf(' ');
        ...
        //    string MsgError = string.Empty;
        //    bool saved = stockLev.Save(dsstockLev,ref MsgError, LoginInfo.ConnStr);
        ...
        //{
        //    // Find deleting row.
        //    DataRow drDeleting = dsstockLev.Tables[stockLev.TableName].Rows.Find(e.Keys[0]);
        //    drDeleting.Delete();
        ...
        //{
        //    DateTime ServerDateTimeTime = ServerDateTime;

        //    DataRow drInserting = dsstockLev.Tables[stockLev.TableName].NewRow();
        ...
        //{
        //    // Find updating row.
        //    DataRow drUpdating = dsstockLev.Tables[stockLev.TableName].Rows.Find(e.Keys[0]);
