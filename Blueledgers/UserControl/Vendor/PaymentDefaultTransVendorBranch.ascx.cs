...
{
    public partial class PaymentDefaultTransVendorBranch : BaseUserControl
    {
        #region "Attributies"

        private Blue.BL.Bank.Bank bank = new Blue.BL.Bank.Bank();
        private DataSet dsBranch = new DataSet();
        ...
        private void Page_Retrieve()
        {
            ...
            bank.GetBankList(dsBranch, LoginInfo.ConnStr);
        }
        ...
        private void Page_Setting()
        {
            ...
            grd_Result.DataSource = dsBranch.Tables[bank.TableName];
            grd_Result.DataBind();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dsBranch = (DataSet)Session["dsBranch"];
            }
        }
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentTransVendorBranchPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentTransVendorBranchPoup");
            MolPaymentTransVendorBranchPoup.Show();

            // request search content.
            string Search_Param = this.txt_Search.Text.Trim();

            // query for match value.
            DataTable dtSearch = bank.GetSearchBranchList(Search_Param, LoginInfo.ConnStr);
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "TransVendorBranchCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BranchCode").ToString() +
                    "','" + DataBinder.Eval(e.Row.DataItem,"BranchName").ToString() +
                    "')");
                ...
                {
                    Label lbl_BranchCode = (Label)e.Row.FindControl("lbl_BranchCode");
                    lbl_BranchCode.Text = DataBinder.Eval(e.Row.DataItem, "BranchCode").ToString();
                }

                // Branch Name
                if (e.Row.FindControl("lbl_BranchName") != null)
                {
                    Label lbl_BranchName = (Label)e.Row.FindControl("lbl_BranchName");
                    lbl_BranchName.Text = DataBinder.Eval(e.Row.DataItem, "BranchName").ToString();
                }
