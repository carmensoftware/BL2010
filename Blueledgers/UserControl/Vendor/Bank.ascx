<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Bank.ascx.cs" Inherits="BlueLedger.PL.UserControls.AP.Bank" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function ChequeBankCode_Click(accountCode,accountName)
       {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl3_grd_PaymentCheque__ctl2_txt_BankCodeCheque').value      = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl3_grd_PaymentCheque__ctl2_txt_BankNameCheque').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl3_grd_PaymentCheque__ctl2_MolPaymentBankPopup');
       }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl3_grd_PaymentCheque__ctl2_MolPaymentBankPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
