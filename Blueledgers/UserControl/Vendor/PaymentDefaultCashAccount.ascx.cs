...
{
    public partial class PaymentDefaultCashAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentDefaultCashAccountPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentDefaultCashAccountPopup");
            MolPaymentDefaultCashAccountPopup.Show();
