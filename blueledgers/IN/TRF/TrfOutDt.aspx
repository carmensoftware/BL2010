<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrfOutDt.aspx.cs" Inherits="BlueLedger.PL.IN.TRF.TrfOutDt"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cph_Main">
    <table border="0" cellpadding="1" cellspacing="0" width="100%">
        <tr style="background-color: #4d4d4d; height: 17px;">
            <td align="left" style="padding-left: 10px;">
                ...
                <table border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="Transfer Out" SkinID="LBL_HD_WHITE"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
            <td style="background-color: #4d4d4d" width="38px">
                <dx:ASPxButton ID="btn_Edit" runat="server" BackColor="Transparent" Height="16px"
                    Width="38px" OnClick="btn_Edit_Click" ToolTip="Edit" Border-BorderStyle="None">
            ...
            <td style="background-color: #4d4d4d" width="41px">
            ...
            <td style="background-color: #4d4d4d" width="43px">
    ...
    <%--<dx:ASPxGridView ID="grd_TrfOutDt" runat="server" SkinID="Default2" AutoGenerateColumns="False"
        Width="100%" KeyFieldName="RefId" OnDetailRowExpandedChanged="grd_TrfOutDt_DetailRowExpandedChanged"
        OnHtmlRowCreated="grd_TrfOutDt_HtmlRowCreated">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Unit" VisibleIndex="3" FieldName="Unit" Width="5%">
                <FooterTemplate>
                    <asp:Label ID="Label3" runat="server" Text="Total Qty:" SkinID="LBL_HD_W"></asp:Label>
                </FooterTemplate>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Qty Allocated" VisibleIndex="4" FieldName="QtyAllocate"
                Width="10%">
                <HeaderStyle HorizontalAlign="Right" />
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Caption="Qty Tr/Out" VisibleIndex="5" FieldName="QtyOut"
                Width="10%">
                <HeaderStyle HorizontalAlign="Right" />
            </dx:GridViewDataTextColumn>
        </Columns>
        <TotalSummary>
            <dx:ASPxSummaryItem FieldName="QtyAllocate" ShowInColumn="Qty Allocated" SummaryType="Sum"
            ...
            <DetailRow>
                <asp:Panel ID="p_Trans" runat="server">
                    <table border="0" cellpadding="3" cellspacing="0" width="100%">
                        <tr style="background-color: #999999; color: #ffffff;">
                            <td>
                                <asp:Label ID="Label36" runat="server" SkinID="LBL_HD" Text="Transaction Detail"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <table border="0" cellpadding="3" cellspacing="0" style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="width: 20%">
                                            <asp:Label ID="Label30" runat="server" SkinID="LBL_HD" Text="Qty Approved:"></asp:Label>
                                        </td>
                                        <td style="width: 30%">
                                            <asp:Label ID="Label31" runat="server" SkinID="LBL_HD" Text="SR:"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                            <asp:Label ID="lbl_Debit" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                        <td style="width: 30%">
                                            <asp:Label ID="lbl_DebitName" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                        <td style="width: 20%">
                                            <asp:Label ID="lbl_QtyAppr" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                        <td style="width: 30%">
                                            <asp:Label ID="lbl_Sr" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                        ...
                                        <td style="width: 20%">
                                            <asp:Label ID="Label34" runat="server" SkinID="LBL_HD" Text="Qty Requested:"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 20%">
                                            <asp:Label ID="lbl_Credit" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                        <td style="width: 30%">
                                            <asp:Label ID="lbl_CreditName" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </td>
                                        <td style="width: 20%">
                ...
                <asp:Panel ID="p_Comment" runat="server">
                    <table border="0" cellpadding="3" cellspacing="0" width="100%">
                        <tr style="background-color: #999999; color: #ffffff;">
                            <td>
                                <asp:Label ID="Label20" runat="server" Text="Comment" SkinID="LBL_HD"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <asp:GridView ID="grd_TrfOutDt" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
        SkinID="GRD_V1" Width="100%" OnRowDataBound="grd_TrfOutDt_RowDataBound" OnRowCommand="grd_TrfOutDt_RowCommand">
        <Columns>
            <asp:TemplateField>
                <HeaderStyle Width="2%" />
                    ...
                    <table border="0" cellpadding="3" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td align="right" style="width: 13%">
                                <asp:Label ID="Label13" runat="server" Text="Qty Allocated" SkinID="LBL_HD_W"></asp:Label>
                            </td>
                            <td align="right" style="width: 13%">
                                <asp:Label ID="Label14" runat="server" Text="Qty Out" SkinID="LBL_HD_W"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </HeaderTemplate>
                    ...
                    <asp:Panel ID="p_Item" runat="server">
                        <table border="0" cellpadding="3" cellspacing="0" width="100%">
                            <tr>
                                ...
                                <td style="width: 64%; white-space: nowrap; overflow: hidden">
                                    <asp:Label ID="lbl_EnglishName" runat="server" SkinID="LBL_NR_GRD" Width="670px"></asp:Label>
                                </td>
                                <%--<td style="width: 32%">
                                ...
                                <td align="right" style="width: 13%">
                                    <asp:Label ID="lbl_QtyOut" runat="server" SkinID="LBL_NR_GRD"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <%--style="display: none"--%>
                    <tr id="TR_TrfOutDetail" runat="server" style="display: block">
                    ...
                    <tr>
                        <td align="right">
                            <%--<dx:ASPxButton ID="btn_ConfirmVoid" CausesValidation="false" runat="server" Text="Yes"
                                SkinID="BTN_N1" OnClick="btn_ConfirmVoid_Click">
                            </dx:ASPxButton>--%>
                            <asp:Button ID="btn_ConfirmVoid" runat="server" Text="Yes" Width="50px" SkinID="BTN_V1"
                                OnClick="btn_ConfirmVoid_Click" />
                        </td>
                        <td align="left">
                            ...
                            <asp:Button ID="btn_CancelVoid" runat="server" Text="No" Width="50px" SkinID="BTN_V1"
                                OnClick="btn_CancelVoid_Click" />
                        </td>
                    </tr>
                </table>
