<%@ Control Language="C#" AutoEventWireup="true" CodeFile="InvoiceAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.InvoiceAccount" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function InvoiceAccountCode_Click(accountCode,accountName,accountObject,accountNameObject,ModalPoupObject)
        {
