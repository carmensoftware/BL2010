...
{
    public class LedgersDraft : DbHandler
    {
        #region "Attributes"
        ...
        public LedgersDraft()
        {
            SelectCommand = "SELECT * FROM GL.LedgersDraft";
            TableName = "LedgersDraft";
        }
        ...
        {
            return DbRetrieveSchema("GL.GetLedgersDraftList", dsLedger, null, TableName, strConn);
        }
