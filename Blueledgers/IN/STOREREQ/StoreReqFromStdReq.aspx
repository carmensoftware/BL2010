<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StoreReqFromStdReq.aspx.cs" Inherits="BlueLedger.PL.IN.STOREREQ.StoreReqEdit" MasterPageFile="~/Master/In/SkinDefault.master" %>
            ...
            <div>
                    ...
                    <tr style="background-color: #4d4d4d; height: 17px;">
                        <td align="left" style="padding-left: 10px;">
                            ...
                            <table border="0" cellpadding="2" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="lbl_StoreReq_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_StoreReq_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td align="right">
                            <table border="0" cellpadding="1" cellspacing="0">
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="btn_Ok" runat="server" BackColor="Transparent" Height="16px" Width="34px" ToolTip="OK" OnClick="btn_Ok_Click">
                                    ...
                                    <td>
                                        <dx:ASPxButton ID="btn_Back" runat="server" BackColor="Transparent" Height="16px" Width="42px" ToolTip="Back" OnClick="btn_Back_Click">
                ...
                <table border="0" cellpadding="0" cellspacing="3" width="100%" class="TABLE_HD">
                    <tr>
                        ...
                        <td style="width: 10%;">
                            <asp:Label ID="lbl_ReqFrom_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_ReqFrom_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td colspan="3">
                            <dx:ASPxComboBox ID="ddl_Store" runat="server" OnLoad="ddl_Store_Load" Width="310px" Height="16px" TextFormatString="{0} : {1}" ValueType="System.String"
                                IncrementalFilteringMode="Contains" AutoPostBack="True" OnSelectedIndexChanged="ddl_Store_SelectedIndexChanged">
                                <Columns>
                    ...
                    <tr>
                        <td style="width: 10%;">
                            <asp:Label ID="lbl_DeliveryDate_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_DeliveryDate_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td style="width: 15%;">
                            <dx:ASPxDateEdit ID="de_DeliveryDate" runat="server" Width="100px">
                            </dx:ASPxDateEdit>
                        </td>
                        <td style="width: 4%;">
                            <asp:Label ID="lbl_Desc_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_Desc_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td style="width: 70%;">
                            <asp:TextBox ID="txt_Desc" runat="server" Width="100%" Height="20px" TextMode="MultiLine" SkinID="TXT_V1"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                <asp:GridView ID="grd_StoreReqFromStdReq" runat="server" SkinID="GRD_V1" AutoGenerateColumns="False" ShowFooter="True" EmptyDataText="No data to display"
                    OnRowDataBound="grd_StoreReqFromStdReq_RowDataBound" Width="100%" HorizontalAlign="Left" EnableModelValidation="True">
                    <Columns>
                        <asp:TemplateField>
                            <HeaderStyle Width="10%" HorizontalAlign="Left"></HeaderStyle>
                            <HeaderTemplate>
                                <asp:Label ID="lbl_ProductCode_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_ProductCode_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:Label ID="lbl_EnglishName_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_EnglishName_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            <HeaderStyle Width="30%" HorizontalAlign="Left"></HeaderStyle>
                            <HeaderTemplate>
                                <asp:Label ID="lbl_LocalName_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_LocalName_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:Label ID="lbl_OnHand_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_OnHand_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                    ...
                    <asp:Label ID="lbl_LocalName_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_LocalName_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                        ...
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:Label ID="lbl_QtyReq_Nm" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, lbl_QtyReq_Nm %>" SkinID="LBL_HD_WHITE"></asp:Label>
                            </HeaderTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <dx:ASPxSpinEdit ID="txt_Qty" runat="server" HorizontalAlign="Right" Width="95%" Height="17px" AutoPostBack="false" SkinID="TXT_NUM_V1">
                ...
                <dx:ASPxPopupControl ID="pop_Warning" ClientInstanceName="pop_Warning" runat="server" CloseAction="CloseButton" HeaderText="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, Warning %>"
                    PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False" AllowResize="True">
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl3" runat="server">
                            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <ClientSideEvents Click="function(s, e) {
                                        ...
                                        <asp:Button ID="btn_Warning" runat="server" Text="<%$ Resources:IN_STOREREQ_StoreReqFromStdReq, btn_Warning %>" SkinID="BTN_V1" OnClick="btn_Warning_Click"
                                            Width="50px" />
                                    </td>
                                </tr>
                            </table>
