<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Vendor.ascx.cs" Inherits="BlueLedger.PL.UserControls.AP.Vendor" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       function VendorCode_Click(vendor_Code,vendor_Name)
        {
            //window.document.getElementById('_ctl0_cph_Main_txt_Vendor').value           = vendor_Code;
            window.document.getElementById('_ctl0_cph_Main_txt_VendorName').innerText   = vendor_Name;
            ModalPoupExtenderHide('_ctl0_cph_Main_VendorPopup');
        }
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td>
                        <asp:Label ID="lbl_Title" runat="server" Text="Vendor - Select Vendor" Font-Bold="False"
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD"  OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_VendorPopup');" >Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <asp:GridView ID="grd_Result" SkinID="GRD_NORMAL" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_VendorCode" runat="server" SkinID="LBL_NORMAL" Text="Vendor Code">
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_VendorCode" runat="server" SkinID="LBL_NORMAL"></asp:Label>
                            ...
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:Label ID="lbl_Description" runat="server" SkinID="LBL_NORMAL" Text="Description">
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
