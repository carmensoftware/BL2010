...
{
    public partial class WithholdingAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molWithHoldingPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolWithHoldingPopup");
            molWithHoldingPopup.Show();
        ...
        protected void lnkb_Close_Click(object sender, EventArgs e)
        {
            ...
            lnkb_Close.Attributes.Add("OnClick", string.Format("ModalPoupExtenderHide('{0}');", molWithHoldingPopup.ClientID));
        }
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                var txtWithHoldingAccount = (TextBox) Parent.FindControl("txt_WithHoldingAccount");
                var txtWithHoldingAccountName = (TextBox) Parent.FindControl("txt_WithHoldingAccountName");
                var molWithHoldingPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolWithHoldingPopup");

                e.Row.Attributes.Add("onMouseOver", "GridView_Row_MouseOver(this);");
                e.Row.Attributes.Add("onMouseOut", "GridView_Row_MouseOut(this);");
                e.Row.Attributes.Add("onDblClick", string.Format("WithHoldingAccount_Click('{0}','{1}','{2}','{3}','{4}')", DataBinder.Eval(e.Row.DataItem, "AccountCode"), DataBinder.Eval(e.Row.DataItem, "NameEng"), txtWithHoldingAccount.ClientID, txtWithHoldingAccountName.ClientID, molWithHoldingPopup.ClientID));
