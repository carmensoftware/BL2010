...
{
    public partial class PaymentDefaultAutoBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentAutoBankPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentAutoBankPoup");
            MolPaymentAutoBankPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "BankCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BankCode").ToString() +
