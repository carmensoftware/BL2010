<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="SPO.aspx.cs" Inherits="BlueLedger.PL.IN.SPO.SPO" %>
        ...
        <tr>
            <td align = "left">
                                ...
                                <PanelCollection>
                                    <dx:PanelContent>
                                        <dx:ASPxMenu ID="menu_CmdBar" runat="server" SkinID="COMMAND_BAR" 
                                            AutoPostBack="True" OnItemClick="ASPxMenu1_ItemClick">
                                            <Items>
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Spoil/Damage#" Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_Spo" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align = "right">
