<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WithholdingAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.WithholdingAccount" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function WithHoldingAccount_Click(accountCode,accountName,accountObject,accountNameObject,ModalPoupObject)
      {
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClick="lnkb_Close_Click" Text="Close"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
