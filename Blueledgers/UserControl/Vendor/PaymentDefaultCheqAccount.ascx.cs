...
{
    public partial class PaymentDefaultCheqAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentDefaultCheqAccountPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentDefaultCheqAccountPoup");
            MolPaymentDefaultCheqAccountPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "ChequeAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode").ToString() +
