...
{
    public partial class PaymentCreditBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentCreditBankPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentCreditBankPopup");
            molPaymentCreditBankPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", string.Format("CreditBankCode_Click('{0}','{1}')", DataBinder.Eval(e.Row.DataItem, "BankCode"), DataBinder.Eval(e.Row.DataItem, "Name")));
