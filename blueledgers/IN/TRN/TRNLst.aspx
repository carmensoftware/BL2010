<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="TRNLst.aspx.cs" Inherits="BlueLedger.PL.IN.TRN.TRNLst" %>
        ...
        <tr>
            <td align="left">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        <td align = "center">
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" style="width: 100%" 
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Transfer#" VisibleIndex="2">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewDataTextColumn>
