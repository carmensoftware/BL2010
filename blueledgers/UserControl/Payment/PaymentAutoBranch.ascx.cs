...
{
    public partial class PaymentAutoBranch : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentAutoBranchPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentAutoBranchPopup");
            molPaymentAutoBranchPopup.Show();
