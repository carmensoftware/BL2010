<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="REQEdit.aspx.cs" Inherits="BlueLedger.PL.IN.REQ.REQEdt" %>
    ...
    <table style="width: 100%;" border="0" cellpadding="5" cellspacing="0">
        <tr>
            <td align="left">
                ...
                </dx:PanelContent></PanelCollection></dx:ASPxRoundPanel></td></tr></table><br />
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Requisition No." Font-Bold="true"></asp:Label></td><td>
                            <asp:TextBox ID="txt_ReqNo" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td align = "right">
                            <asp:Label ID="Label3" runat="server" Text="From Location" Font-Bold="true"></asp:Label></td><td>
                    ...
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label4" runat="server" Text="Requisition Date" Font-Bold="true"></asp:Label></td><td>
                            <asp:TextBox ID="txt_ReqDate" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td align = "right">
                            <asp:Label ID="Label5" runat="server" Text="Delivery Date" Font-Bold="true"></asp:Label></td><td>
                            <asp:TextBox ID="txt_DeliveryDate" runat="server"></asp:TextBox></td></tr></table>
                    <table border = "0" cellpadding = "1" cellspacing = "5">
                        <tr>
                            <td align = "right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="Label6" runat="server" Text="Comment" Font-Bold="true"></asp:Label></td><td>
                            <asp:TextBox ID="txt_Comment" runat="server" Width = "410px"></asp:TextBox></td>
                        </tr>
                    </table><br />
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        ...
                        <td align = "right">
                            ...
                            <asp:TextBox ID="txt_TotalOnOrder" runat="server"></asp:TextBox></td></tr></table><br />
            </td>
        </tr>
    </table>
</asp:Content>
