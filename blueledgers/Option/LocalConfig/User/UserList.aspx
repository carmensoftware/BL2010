<%@ Page Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="UserList.aspx.cs" Inherits="BlueLedger.PL.Option.Admin.Security.User.UserList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Main" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
                    ...
                    <td align="left">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr style="background-color: #4d4d4d; height: 17px;">
                                ...
                                <td align="right">
                                    <asp:ImageButton ID="btnAddUser" AlternateText="AddUser" runat="server" OnClick="Create"
                                        ImageUrl="~/App_Themes/Default/Images/master/icon/create.png" />
                                </td>
                            </tr>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <table border="0" cellpadding="2" cellspacing="0">
                                        <tr>
                                            <td align="left">
                                                ...
                                                <asp:DropDownList ID="ddlActive" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlActive_OnSelectedIndexChanged">
                                                    <asp:ListItem Selected="True">All</asp:ListItem>
                                                    <asp:ListItem>Active</asp:ListItem>
                                                    <asp:ListItem>Inactive</asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:LinkButton ID="btnRresh" Text="Refresh" Font-Underline="false" ForeColor="Black"
                                                    runat="server" OnClick="btnHome_Click"></asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td align="right">
                                    <asp:Panel ID="pntxt" runat="server" DefaultButton="btnS" Width="100%">
                                        <div>
                                            ...
                                            <asp:ImageButton ID="btnS" AlternateText="Search" runat="server" OnClick="btnS_Click"
                                                ImageUrl="~/App_Themes/Default/Images/master/in/Default/search.png" />
                                        </div>
                                    </asp:Panel>
                                </td>
                            </tr>
            ...
            <asp:GridView ID="gvUserList" runat="server" AutoGenerateColumns="false" DataKeyNames="loginName"
                Width="100%" BackColor="White" BorderColor="#DDDDDD" GridLines="Horizontal" Font-Names="Arial"
                Font-Size="12px" OnSelectedIndexChanged="gvUserList_SelectedIndexChanged" OnRowDataBound="gvUserList_RowDataBound">
            ...
            <cc1:ModalPopupExtender ID="pop_UserInfo" runat="server" PopupControlID="panel_UserInfo"
                TargetControlID="btnUserInfo" CancelControlID="ButtonClose" BehaviorID="pop_UserInfo"
            ...
            <dx:ASPxPopupControl ID="pop_ReachMaxUserNo" runat="server" Width="400px" HeaderText="<%$ Resources:Option_Admin_Security_User_User, Msg2 %>"
                ...
                <ContentCollection>
                    <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
                        <asp:Label ID="Label9" runat="server" Text="<%$ Resources:Option_Admin_Security_User_User, MsgWarning2 %>"
