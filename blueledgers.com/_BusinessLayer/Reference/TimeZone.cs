...
namespace Blue.BL.Reference
{
    public class TimeZone : DbHandler
    {
        ...
        public TimeZone()
        {
            SelectCommand = "SELECT * FROM Reference.TimeZone";
            TableName = "TimeZone";
        }
        ...
        {
            DbRetrieve("Reference.GetTimeZoneList", dsTimeZone, null, TableName, connStr);
        }
        ...
        {
            return DbRead("Reference.GetTimeZoneLookup", null, connStr);
        }
        ...
        public bool GetByTimeZoneID(string timeZoneID, DataSet dsTimeZone, string connStr)
        {
            ...
            // Get data
            result = DbRetrieve("Reference.GetTimeZoneByID", dsTimeZone, dbParams, TableName, connStr);
        ...
        public string GetName(string timeZoneID, string connStr)
        {
            ...
            {
                result = dsTimeZone.Tables[TableName].Rows[0]["Name"].ToString();
            }
