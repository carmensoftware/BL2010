<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="StockLev.aspx.cs" Inherits="BlueLedger.PL.Option.Inventory.StockLev" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Main" runat="Server">
    <div align="left">
        ...
        <uc1:ListPage ID="ListPage1" runat="server" AllowViewCreate="False" 
            KeyFieldName="LocationCode" PageCode="[IN].[vStockLevelList]" 
            Title="Stock Level" />
    </div>
</asp:Content>
