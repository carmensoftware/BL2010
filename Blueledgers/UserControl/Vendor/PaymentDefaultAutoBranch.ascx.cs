...
{
    public partial class PaymentDefaultAutoBranch : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentAutoBranchPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentAutoBranchPoup");
            MolPaymentAutoBranchPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "BranchCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BranchCode").ToString() +
