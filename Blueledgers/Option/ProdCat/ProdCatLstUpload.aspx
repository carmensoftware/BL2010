<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProdCatLstUpload.aspx.cs" Inherits="Option_ProdCat_ProdCatLstUpload" %>
    ...
    <div style="width: 380px;">
        <div style="border-bottom: 1px solid #C9C9C9; padding-bottom: 50px;">
            <table width="100%">
                <tr class="popUpline">
                    <td align="left">
                        <asp:Label ID="lbltxt01" Text="Click 'Template' button to get template." runat="server"></asp:Label>
                    </td>
                    <td align="right">
                        <asp:Button ID="btnExport" runat="server" Text="Template" Width="100px" OnClick="btnExport_Click" />
                    </td>
                </tr>
            </table>
        </div>
        <div style="padding-top: 10px;">
            <table width="100%">
                <tr>
                    ...
                    <td align="right">
                        <asp:Button ID="btnUpload" runat="server" Enabled="False" OnClick="btnUpload_Click" Text="Import" Width="100px" />
                    </td>
                </tr>
            </table>
        </div>
