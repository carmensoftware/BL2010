<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentDefaultTransVendorBank.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentDefaultTransVendorBank" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function TransVendorBankCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl6_grd_PaymentTransferVendor__ctl2_txt_TransVendorBank').value      = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl6_grd_PaymentTransferVendor__ctl2_txt_TransVendorBankName').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl6_grd_PaymentTransferVendor__ctl2_MolPaymentTransVendorBankPoup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl6_grd_PaymentTransferVendor__ctl2_MolPaymentTransVendorBankPoup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
