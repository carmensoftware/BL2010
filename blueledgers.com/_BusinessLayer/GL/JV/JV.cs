...
namespace Blue.BL.GL.JV
{
    public class JV : DbHandler
    {
        ...
        public JV()
        {
            SelectCommand = "SELECT * FROM GL.JV";
            TableName = "JV";
        }
        ...
        {
            return DbRetrieveSchema("GL.GetJVList", dsJV, null, TableName, strConn);
        }
        ...
        public bool Save(DataSet savedData, string connStr)
        {
            ...
            dbSaveSource[0] = new DbSaveSource(savedData, SelectCommand, TableName);
            dbSaveSource[1] = new DbSaveSource(savedData, jvDt.SelectCommand, jvDt.TableName);
            dbSaveSource[2] = new DbSaveSource(savedData, ledgers.SelectCommand, ledgers.TableName);
