<%@ Control Language="C#" AutoEventWireup="true" CodeFile="VendorDefaultWHTAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.VendorDefaultWHTAccount" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function VendorDefaultWHTAccountCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl7_grd_PaymentWithholding__ctl2_txt_WithAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl7_grd_PaymentWithholding__ctl2_txt_WithAccountName').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl7_grd_PaymentWithholding__ctl2_MolVendorDefaultWHTAccountPoup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl7_grd_PaymentWithholding__ctl2_MolVendorDefaultWHTAccountPoup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
