<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="REQ.aspx.cs" Inherits="BlueLedger.PL.IN.REQ.REQ" %>
        ...
        <tr>
            <td align = "left">
                <table border="0" cellpadding="1" cellspacing="0" style="width: 100%;">
                    <tr style="height: 40px;">
                        <td style="border-bottom: solid 5px #187EB8">
                            <asp:Label ID="lbl_Title" runat="server" Text="Requisition" Font-Size="13pt"
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Requisition No." Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_ReqNo" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align="right">
                            <asp:Label ID="Label3" runat="server" Text="From Location" Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_FromLocation" runat="server" Width = "150px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <asp:Label ID="Label4" runat="server" Text="Requisition Date" Font-Bold="true"></asp:Label></td>
                        <td>
                            <asp:Label ID="lbl_ReqDate" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td align="right">
                            <asp:Label ID="Label5" runat="server" Text="Delivery Date" Font-Bold="true"></asp:Label></td>
                        <td>
                            <asp:Label ID="lbl_DeliveryDate" runat="server" Width = "150px"></asp:Label></td></tr></table>
                    <table border = "0" cellpadding = "1" cellspacing = "5">
                        <tr>
                            <td align="right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <td>
                                <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width = "100%" 
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="Canceled Qty." VisibleIndex="10">
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Remark" VisibleIndex="11">
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Caption="Req.Status" VisibleIndex="12">
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                </dx:ASPxGridView>
                    ...
                    <tr>
                        ...
                        <td align = "right">
                            <asp:Label ID="Label15" runat="server" Text="Total On Order" Font-Bold="true"></asp:Label></td><td>
                                <asp:Label ID="lbl_TotalOnOrder" runat="server" Width = "150px"></asp:Label></td></tr></table><br />
                      <table width = "100%" border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Button ID="Button5" runat="server" Text="Approve" />&nbsp;
                            <asp:Button ID="Button1" runat="server" Text="Reject" />&nbsp;
                            <asp:Button ID="Button2" runat="server" Text="Send Back" />
                        </td>
                    </tr>
                </table>
            </td>
