<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrfOutLst.aspx.cs" Inherits="BlueLedger.PL.IN.TRF.TrfOutLst"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Main" runat="Server">
    <uc1:ListPage2 ID="ListPage2" runat="server" PageCode="[IN].[vTransferOutList]" DetailPageURL="TrfOutDt.aspx"
        KeyFieldName="RefId" AllowDelete="False" AllowPrint="True" Title="Transfer Out"
        AllowCreate="True" />
    <%--<uc1:ListPageStdReq ID="ListPage" runat="server" PageCode="[IN].[vTransferOutList]" DetailPageURL="TrfOutDt.aspx" KeyFieldName="RefId"
        AllowDelete="False" AllowPrint="True" Title="Transfer Out" 
        AllowCreate="True" />--%>
