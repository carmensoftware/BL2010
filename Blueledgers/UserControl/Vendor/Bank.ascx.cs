...
{
    public partial class Bank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentBankPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentBankPopup");
            MolPaymentBankPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "ChequeBankCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BankCode").ToString() +
