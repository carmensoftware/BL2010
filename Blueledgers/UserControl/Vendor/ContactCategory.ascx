<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ContactCategory.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.ContactCategory" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function ContactCategoryCode_Click(contact_CategoryCode,contact_CategoryName)
        {
            window.document.getElementById('_ctl0_cph_Main_grd_Contact__ctl2_hid_ContactCategoryCode').value   = contact_CategoryCode;
            window.document.getElementById('_ctl0_cph_Main_grd_Contact__ctl2_txt_ContactCategory').innerText   = contact_CategoryName;
            ModalPoupExtenderHide('_ctl0_cph_Main_grd_Contact__ctl2_MolContactCategoryPopup');
        }
    ...
    <tr>
        <td>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td>
                        <asp:Label ID="lbl_Title" runat="server" Text="Contact - Select ContactCategory"
                            Font-Bold="False" SkinID="LBL_BOLD_HEADER"></asp:Label>
                    </td>
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_grd_Contact__ctl2_MolContactCategoryPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                <tr style="height: 25px">
                    ...
                    <td style="background-color: #76E776">
                        <asp:Label ID="lbl_Lookup" runat="server" SkinID="LBL_BOLD_WHITE" Text="Contact"></asp:Label>
                    </td>
                    ...
                    <asp:GridView ID="grd_Result" SkinID="GRD_NORMAL" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <HeaderTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_ContactCategoryCode" runat="server" SkinID="LBL_NORMAL" Text="ContactCategory Code">
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="lbl_ContactCategoryCode" runat="server" SkinID="LBL_NORMAL"></asp:Label>
                                    <asp:Label ID="lbl_ContactName" runat="server" SkinID="LBL_NORMAL"></asp:Label>
                                </ItemTemplate>
