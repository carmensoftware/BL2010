<%@ Page Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="AccountMapp.aspx.cs" Inherits="BlueLedger.PL.Option.Admin.Interface.AccpacGL.AccountMapp" %>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cmb_BusinessUnitCode" runat="server" EnableCallbackMode="true"
                                            ...
                                            ValueField="BuCode"
                                            OnItemRequestedByValue="cmb_BusinessUnitCode_OnItemRequestedByValue" TextFormatString="{0}"
                                            TextField="BuName" Enabled="false" Width="155px" AutoPostBack="true" Font-Names="Arial"
                                    ...
                                    <td>
                                        <dx:ASPxComboBox ID="cmb_Store" runat="server" EnableCallbackMode="true" CallbackPageSize="10"
                                            ...
                                            <Columns>
                                                <dx:ListBoxColumn FieldName="LocationName" Caption="Store" Width="230px" />
                                            </Columns>
                                        </dx:ASPxComboBox>
                                    </td>
                                    <td valign="top">
                                        <table border="0" cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <dx:ASPxComboBox ID="cmb_ItemGroup" runat="server" EnableCallbackMode="true" CallbackPageSize="10"
                                                        IncrementalFilteringMode="Contains" ValueType="System.String" ValueField="CategoryCode"
                                                        TextFormatString="{0}"
                                                        TextField="CategoryName" Width="155px" AutoPostBack="true" Font-Names="Arial"
                                                        Font-Size="9pt" onselectedindexchanged="cmb_ItemGroup_SelectedIndexChanged"
                                                        onitemrequestedbyvalue="cmb_ItemGroup_ItemRequestedByValue" 
                                                        onitemsrequestedbyfiltercondition="cmb_ItemGroup_ItemsRequestedByFilterCondition" >
                                                        <Columns>
                                                            <dx:ListBoxColumn FieldName="CategoryName" Caption="Category" Width="230px" />
                                                        </Columns>
                                                    </dx:ASPxComboBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <dx:ASPxComboBox ID="cmb_Type" runat="server" IncrementalFilteringMode="Contains"
                                                        ...
                                                        <Items>
                                                            <dx:ListEditItem Text="Movement Type" Value="AdjCode" Selected="true" />
                                                        </Items>
                                                    </dx:ASPxComboBox>
                                                </td>
                                            </tr>
                        ...
                        <td colspan="2">
                            <asp:GridView ID="grd_AccountMapp" runat="server" SkinID="GRD_V1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="lbl_ItemGroup_Nm" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_ItemGroup_Nm %>"
                                                SkinID="LBL_HD_W"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:HiddenField ID="hid_ItemGroup" runat="server" />
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label ID="lbl_AdjCode_Nm" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_AdjType_Nm %>"
                                                SkinID="LBL_HD_W"></asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <%--<asp:HiddenField ID="hid_ItemGroupCode" runat="server" />--%>
                                            <asp:HiddenField ID="hid_AdjCode" runat="server" />
                                            <asp:Label ID="lbl_AdjCode" runat="server" SkinID="LBL_NR"></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Width="8%" HorizontalAlign="Left" />
                                        <ItemStyle Width="8%" HorizontalAlign="Left" />
                                    </asp:TemplateField>
...
--%>                                        </tr>
    ...
    <dx:ASPxPopupControl ID="pop_Warning" ClientInstanceName="pop_Warning"
        ...
        <contentcollection>
                <dx:PopupControlContentControl ID="PopupControlContentControl8" runat="server">
                    <table border="0" cellpadding="5" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td align="center">
                                <asp:Button ID="btn_Warning" runat="server" Text="OK"
                                    Width="50px" SkinID="BTN_V1" OnClick="btn_Warning_Click" />
                            </td>
                        </tr>
                    </table>
