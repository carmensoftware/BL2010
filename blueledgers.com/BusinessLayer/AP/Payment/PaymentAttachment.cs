...
{
    public class PaymentAttachment : DbHandler
    {
        #region "Attributies"
        ...
        {
            SelectCommand = "SELECT * FROM AP.PaymentAttachment";
        ...
        public bool GetList(DataSet dsAttachment, string refNo, string connectionString)
        {
            ...
            return DbRetrieve("AP.GetPaymentAttachmentListByRefNo", dsAttachment, dbParams, TableName, connectionString);
        }
        ...
        public bool GetStructure(DataSet dsAttachment, string connectionString)
        {
            ...
            return DbRetrieveSchema("AP.GetPaymentAttachmentList", dsAttachment, null, TableName, connectionString);
        }
