...
using DevExpress.Web.ASPxEditors;using BlueLedger;

using BlueLedger.PL.BaseClass;

namespace BlueLedger.PL.UserControls.AP
{
    public partial class PaymentDefaultAutoAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentAutoAccountPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentAutoAccountPoup");
            MolPaymentAutoAccountPoup.Show();
