<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="TRNEdit.aspx.cs" Inherits="BlueLedger.PL.IN.TRN.TRN" %>
        ...
        <tr>
            <td align="left">
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Transfer No." Font-Bold="true"></asp:Label></td><td>
                            <asp:TextBox ID="txt_TrnNo" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td align = "right">
                    ...
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label4" runat="server" Text="From Location" Font-Bold="true"></asp:Label></td><td>
                            <asp:DropDownList ID="DropDownList1" runat="server" Width = "155px">
                            </asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td align = "right">
                            <asp:Label ID="Label5" runat="server" Text="To Location" Font-Bold="true"></asp:Label></td><td>
                    ...
                    <table border = "0" cellpadding = "1" cellspacing = "5">
                        <tr>
                            ...
                            <asp:TextBox ID="txt_Comment" runat="server" Width = "395px"></asp:TextBox></td>
                        </tr>
                    </table><br />
