...
{
    public partial class PaymentDefaultTransBranch : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentTransBranchPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentTransBranchPoup");
            MolPaymentTransBranchPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "TransBranchCode_Click('" + DataBinder.Eval(e.Row.DataItem, "BranchCode").ToString() +
