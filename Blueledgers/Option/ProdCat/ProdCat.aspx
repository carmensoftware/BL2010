<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true" CodeFile="ProdCat.aspx.cs" Inherits="BlueLedger.PL.Option.ProdCat.ProdCat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Main" runat="Server">
    <asp:UpdatePanel ID="UdPnDetail" runat="server">
        <ContentTemplate>
                    ...
                    <td align="left" style="padding-left: 10px;">
                        <table border="0" cellpadding="2" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lbl_Title" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_Title %>" SkinID="LBL_HD_WHITE"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td align="right">
                        <dx:ASPxMenu runat="server" ID="menu_CmdBar" AutoPostBack="True" Font-Bold="True" BackColor="Transparent" Border-BorderStyle="None" ItemSpacing="2px" VerticalAlign="Middle"
            ...
            <asp:Panel ID="Panel1" runat="server">
                <table border="0" cellpadding="1" cellspacing="0" width="100%" class="TABLE_HD">
                    <tr>
                        ...
                        <td style="width: 12%">
                            <asp:Label ID="lbl_CatCode_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_CatCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_CatName_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_CatName_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_TaxAccCode_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_TaxAccCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_AppLv_Nm0" runat="server" SkinID="LBL_HD" Text="<%$ Resources:Option.ProdCat.Category, lbl_AppLv_Nm %>" Visible="False"></asp:Label>
                        </td>
                        <td>
            ...
            <asp:Panel ID="Panel2" runat="server">
                <table border="0" cellpadding="1" cellspacing="0" width="100%" class="TABLE_HD">
                    <tr>
                        ...
                        <td style="width: 13%">
                            <asp:Label ID="Label8" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_CatCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_SubCatCode_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_SubCatCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_SubCatName_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_SubCatName_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label10" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_TaxAccCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label11" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_AppLv_Nm %>" SkinID="LBL_HD" Visible="False"></asp:Label>
                        </td>
                        <td>
            ...
            <asp:Panel ID="Panel3" runat="server">
                <table border="0" cellpadding="1" cellspacing="0" width="100%" class="TABLE_HD">
                    <tr>
                        ...
                        <td style="width: 13%">
                            <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_CatCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label16" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_SubCatCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_IGroupCode_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_IGroupCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lbl_IGroupName_Nm" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_IGroupCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label18" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_TaxAccCode_Nm %>" SkinID="LBL_HD"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label19" runat="server" Text="<%$ Resources:Option.ProdCat.Category, lbl_AppLv_Nm %>" SkinID="LBL_HD" Visible="False"></asp:Label>
                        </td>
                        <td>
            ...
            <!-- Popup -->
            <dx:ASPxPopupControl ID="pop_ConfrimDelete" runat="server" CloseAction="CloseButton" HeaderText="<%$ Resources:Option.ProdCat.Category, MsgHD %>" Modal="True"
                        ...
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td align="center" colspan="2" height="50px">
                                    <asp:Label ID="Label7" runat="server" Text="<%$ Resources:Option.ProdCat.Category, MsgWarning %>" SkinID="LBL_NR"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                SkinID="BTN_V1">
                                    ...
                                    <asp:Button ID="btn_ConfrimDelete" runat="server" Text="<%$ Resources:Option.ProdCat.Category, btn_Confrim %>" OnClick="btn_ConfrimDelete_Click" SkinID="BTN_V1"
                                        Width="50px" />
                                </td>
                                <td align="left">
                                ...
                                SkinID="BTN_V1">
                                    ...
                                    <asp:Button ID="btn_CancelDelete" runat="server" Text="<%$ Resources:Option.ProdCat.Category, btn_Cancel %>" OnClick="btn_CancelDelete_Click" SkinID="BTN_V1"
                                        Width="50px" />
                                </td>
                            </tr>
                        </table>
            ...
            <dx:ASPxPopupControl ID="pop_WarningDelete" runat="server" CloseAction="CloseButton" HeaderText="<%$ Resources:Option.ProdCat.Category, MsgHD %>" Modal="True"
                PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ShowCloseButton="False">
                <ContentCollection>
                    <dx:PopupControlContentControl runat="server">
                        <table border="0" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td align="center" height="50px">
                                    <asp:Label ID="Label20" runat="server" Text="<%$ Resources:Option.ProdCat.Category, MsgWarning2 %>" SkinID="LBL_NR"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td align="center">
                                    SkinID="BTN_V1"> </dx:ASPxButton>--%>
                                    <asp:Button ID="btn_Ok" runat="server" OnClick="btn_Ok_Click" Text="<%$ Resources:Option.ProdCat.Category, btn_SuccessOk %>" Width="50px" SkinID="BTN_V1" />
                                </td>
                            </tr>
                        </table>
                    </dx:PopupControlContentControl>
