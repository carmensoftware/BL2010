<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentTransAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentTransAccount" %>
       ...
       function TransAccountCode_Click(accountCode,accountName)
        {
            ...
            window.document.getElementById('_ctl0_cph_Main_txt_TransPaymentAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_txt_TransPaymentAccount_Name').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransAccountPopup');
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransAccountPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
