...
{
    public partial class SOTLst : BasePage
    {
        #region "Attributes"
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ListPage.PrintItems.Items.Add(new DevExpress.Web.ASPxMenu.MenuItem("Standard Order", "SOD"));
                ListPage.DataBind();
            }
            ...
            //else
            //{
            //    dsTemplate = (DataSet)Session["dsTemplate"];
            //}
        }

        /// <summary>
        ///     Display sto List/Standard Order
        /// </summary>
        ...
        private void menu_ItemClick(object source, DevExpress.Web.ASPxMenu.MenuItemEventArgs e)
        {
            switch (e.Item.Name.ToUpper())
            {
                case "SOD":
                    ...
                    var reportLink = "../../RPT/ReportCriteria.aspx?category=001&reportid=151";
        ...
        //    {
        //        string prId = grdTran.Rows[i].Cells[1].Text;
