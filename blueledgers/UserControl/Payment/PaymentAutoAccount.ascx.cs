...
{
    public partial class PaymentAutoAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentAutoAccountPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentAutoAccountPopup");
            molPaymentAutoAccountPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", string.Format("AccountCode_Click('{0}','{1}')", DataBinder.Eval(e.Row.DataItem, "AccountCode"), DataBinder.Eval(e.Row.DataItem, "NameEng")));
