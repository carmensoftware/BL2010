<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentCreditAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentCreditAccount" %>

<script type="text/javascript" src="../../Scripts/GnxLib.js"></script>

<script type="text/javascript">
       
       function PaymentCreditAccountCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_txt_CreditPaymentAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_txt_CreditPaymentAccount_Name').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentCreditAccountPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentCreditAccountPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
