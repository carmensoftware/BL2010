...
{
    public partial class AccountMapForShipmentTxn : BasePage //System.Web.UI.Page
    {
        #region "Attributes"
        ...
        private void Page_Retrieve()
        {
            ...
            accountMapp.GetList(dsAccountCategory, cmb_Store.SelectedItem.Value.ToString(),
                cmb_Type.SelectedItem.Value.ToString(), LoginInfo.ConnStr, Blue.BL.Option.Admin.Interface.PostType.GL);
        ...
        protected void cmb_BusinessUnitCode_OnItemRequestedByValue(object source, ListEditItemRequestedByValueEventArgs e)
        {
        ...
        protected void grd_AccountMapp_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (e.Row.FindControl("lbl_StoreCode") != null)
                {
                    ...
                    lbl_StoreCode.Text = (cmb_Store.SelectedItem.Text == null ? string.Empty : cmb_Store.SelectedItem.Text);
                }
                ...
                if (e.Row.FindControl("hid_ItemGroupCode") != null)
                {
                    ...
                    var dt = dsAccountMapp.Tables[accountMapp.TableName];
                    var dr = dt.Select("PostType='AP'");

                    ds.Tables[accountMapp.TableName].Rows.Clear();

                    foreach (var drr in dr)
                    {
                        var newRow = ds.Tables[accountMapp.TableName].NewRow();
                        newRow.ItemArray = drr.ItemArray;
                        ds.Tables[accountMapp.TableName].Rows.Add(newRow);
                    }
