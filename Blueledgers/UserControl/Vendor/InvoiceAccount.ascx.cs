...
{
    public partial class InvoiceAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolInvoiceAccountPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolInvoiceAccountPopup");
            MolInvoiceAccountPopup.Show();
        ...
        protected void lnkb_Close_Click(object sender, EventArgs e)
        {
            ...
            lnkb_Close.Attributes.Add("OnClick", "ModalPoupExtenderHide('" + MolInvoiceAccountPopup.ClientID + "');");
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                TextBox txt_Account     = (TextBox)Parent.FindControl("txt_Account");
                TextBox txt_AccountName = (TextBox)Parent.FindControl("txt_AccountName");
                AjaxControlToolkit.ModalPopupExtender MolInvoiceAccountPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolInvoiceAccountPopup");

                e.Row.Attributes.Add("onMouseOver", "GridView_Row_MouseOver(this);");
                e.Row.Attributes.Add("onMouseOut", "GridView_Row_MouseOut(this);");
                e.Row.Attributes.Add("onDblClick", "InvoiceAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode").ToString() +
                    "','" + DataBinder.Eval(e.Row.DataItem, "NameEng").ToString() +
                    "','" + txt_Account.ClientID +
                    "','" + txt_AccountName.ClientID +
                    "','" + MolInvoiceAccountPopup.ClientID +
                    "')");
