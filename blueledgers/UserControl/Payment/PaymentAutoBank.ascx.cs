...
{
    public partial class PaymentAutoBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentAutoBankPopup = (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentAutoBankPopup");
            molPaymentAutoBankPopup.Show();
