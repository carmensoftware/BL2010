<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Account.ascx.cs" Inherits="BlueLedger.PL.UserControls.AP.Account" %>
...
<script type="text/javascript">
       ...
       function AccountCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_grd_BankAccount__ctl2_txt_AccCode').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_grd_BankAccount__ctl2_txt_AccCode_Name').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_grd_BankAccount__ctl2_MolAccountPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_grd_BankAccount__ctl2_MolAccountPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
