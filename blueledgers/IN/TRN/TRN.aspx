<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="TRN.aspx.cs" Inherits="BlueLedger.PL.IN.TRN.TRN" %>
        ...
        <tr>
            <td align = "left">
                <table border="0" cellpadding="1" cellspacing="0" style="width: 100%;">
                    <tr style="height: 40px;">
                        <td style="border-bottom: solid 5px #187EB8">
                            <asp:Label ID="lbl_Title" runat="server" Text="Transfer" Font-Size="13pt"
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label2" runat="server" Text="Transfer No." Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_TrnNo" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align = "right">
                    ...
                    <tr>
                        <td align = "right">
                            <asp:Label ID="Label4" runat="server" Text="From Location" Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_FromLocation" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                        <td align = "right">
                            <asp:Label ID="Label5" runat="server" Text="To Location" Font-Bold="true"></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lbl_ToLocation" runat="server" Width = "150px"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
                <table border = "0" cellpadding = "1" cellspacing = "5">
                ...
                <table border="0" cellpadding="1" cellspacing="5">
                    <tr>
                        ...
                        <td align = "right">
                            <asp:Label ID="Label13" runat="server" Text="Last Prise" Font-Bold="true"></asp:Label></td><td>
