<%@ Page Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="AccountMapForShipmentTxn.aspx.cs" Inherits="BlueLedger.PL.Option.Admin.Interface.ACCPAC.AccountMapForShipmentTxn" %>
        ...
        <ContentTemplate>
            <div>
                                    ...
                                    <td align="left" style="padding-left: 10px;">
                                        <table border="0" cellpadding="2" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lbl_Title" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_Title %>"
                                            ...
                                            <table border="0" cellpadding="1" cellspacing="0">
                                                <tr>
                                                    <td style="padding-left: 10px;">
                                                        <asp:Label runat="server" ID="lbl_BusinessUnitCode" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_Bu_Nm %>"
                                                            SkinID="LBL_HD"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxComboBox ID="cmb_BusinessUnitCode" runat="server" EnableCallbackMode="true"
                                                            CallbackPageSize="10" IncrementalFilteringMode="Contains" ValueType="System.String"
                                                            ValueField="BuCode" OnItemRequestedByValue="cmb_BusinessUnitCode_OnItemRequestedByValue"
                                                            TextFormatString="{0}" TextField="BuName" Enabled="false" Width="155px" AutoPostBack="true"
                                                            Font-Names="Arial" Font-Size="9pt" OnSelectedIndexChanged="cmb_BusinessUnitCode_SelectedIndexChanged">
                                                            <Columns>
                                                    ...
                                                    <td>
                                                        <asp:Label runat="server" ID="lbl_Store_Nm" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_Store_Nm %>"
                                                            SkinID="LBL_HD"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxComboBox ID="cmb_Store" runat="server" EnableCallbackMode="true" CallbackPageSize="10"
                                                            IncrementalFilteringMode="Contains" ValueType="System.String" ValueField="LocationCode"
                                                            OnItemsRequestedByFilterCondition="cmb_Store_OnItemsRequestedByFilterCondition"
                                                            OnItemRequestedByValue="cmb_Store_OnItemRequestedByValue" TextFormatString="{0}"
                                                            TextField="LocationName" Width="155px" AutoPostBack="true" Font-Names="Arial"
                                                            Font-Size="9pt" OnSelectedIndexChanged="cmb_Store_SelectedIndexChanged">
                                                            <Columns>
                                                    ...
                                                    <td valign="top">
                                                        <table border="0" cellpadding="1" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <dx:ASPxComboBox ID="cmb_Type" runat="server" IncrementalFilteringMode="Contains"
                                                                        ValueType="System.String" TextFormatString="{0}" Enabled="true" Width="155px"
                                                                        AutoPostBack="true" Font-Names="Arial" Font-Size="9pt" OnSelectedIndexChanged="cmb_Type_OnSelectedIndexChanged">
                                                                        <Items>
                                                ...
                                                <EmptyDataTemplate>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr style="height: 25px; background-color: #a0a0a0">
                                                            ...
                                                            <td>
                                                                <asp:Label ID="lbl_2" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A2_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_3" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A3_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_4" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A4_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_5" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A5_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_6" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A6_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_7" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A7_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_8" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A8_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_9" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A9_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_10" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A10_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="lbl_11" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.AccountMapp, lbl_A11_Nm %>"
                                                                    SkinID="LBL_HD_W"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                ...
                <dx:ASPxPopupControl ID="pop_Warning" ClientInstanceName="pop_Warning" runat="server"
                    Width="300px" CloseAction="CloseButton" HeaderText="Warning" Modal="True" PopupHorizontalAlign="WindowCenter"
                    ...
                    <ContentCollection>
                        <dx:PopupControlContentControl ID="PopupControlContentControl8" runat="server">
                            <table border="0" cellpadding="5" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="center">
                                        <asp:Button ID="btn_Warning" runat="server" Text="OK" Width="50px" SkinID="BTN_V1"
            ...
            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server" TargetControlID="UpPgDetail"
