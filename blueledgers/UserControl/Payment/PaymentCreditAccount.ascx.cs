...
{
    public partial class PaymentCreditAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentCreditAccountPopup =
                (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentCreditAccountPopup");
            molPaymentCreditAccountPopup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick",
                    "PaymentCreditAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode") +
