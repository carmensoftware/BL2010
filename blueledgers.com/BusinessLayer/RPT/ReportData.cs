...
namespace Blue.BL.RPT
{
    public class ReportData : DbHandler
    {
        ...
        public ReportData()
        {
            SelectCommand = "SELECT * FROM RPT.ReportData";
        ...
        public bool GetList(DataSet dsReportData, string connStr)
        {
            ...
            // Get data
            result = DbRetrieve("RPT.GetReportDataList", dsReportData, null, TableName, connStr);
        ...
        public bool Get(DataSet dsReportData, int reportID, string connStr)
        {
            ...
            // Get data
            result = DbRetrieve("RPT.GetReportDataByReportID", dsReportData, dbParams, TableName, connStr);
