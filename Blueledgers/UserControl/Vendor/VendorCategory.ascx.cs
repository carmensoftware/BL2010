...
{
    public partial class VendorCategory : BaseUserControl
    {
        #region "Attributies"

        private Blue.BL.AP.VendorCategory vendorCategory = new Blue.BL.AP.VendorCategory();
        private DataSet dsVendorCategory            = new DataSet();
        ...
        {
            // For vendorCategory detail aspxgrid.
            vendorCategory.GetVendorCategoryList(dsVendorCategory,LoginInfo.ConnStr);
        }
        ...
        private void Page_Setting()
        {
            ...
            // Binding vendorCategory detail gridview.
            grd_Result.DataSource = dsVendorCategory.Tables[vendorCategory.TableName];
            grd_Result.DataBind();
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                dsVendorCategory = (DataSet)Session["dsVendorCategory"];
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolVendorCategoryPopup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolVendorCategoryPopup");
            MolVendorCategoryPopup.Show();

            // request search content.
            string Search_Param = this.txt_Search.Text.Trim();

            // query for match value.
            DataTable dtSearch = vendorCategory.GetSearchVendorCategoryList(Search_Param, LoginInfo.ConnStr);
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "VendorCategoryCode_Click('" + DataBinder.Eval(e.Row.DataItem, "VendorCategoryCode").ToString() +
                    "','" + DataBinder.Eval(e.Row.DataItem, "Name").ToString() +
                    "')");
                e.Row.Style.Add("cursor", "hand");

                // Vendor Code
                if (e.Row.FindControl("lbl_VendorCategoryCode") != null)
                {
                    Label lbl_VendorCategoryCode  = (Label)e.Row.FindControl("lbl_VendorCategoryCode");
                    lbl_VendorCategoryCode.Text   = DataBinder.Eval(e.Row.DataItem, "VendorCategoryCode").ToString();
                }
