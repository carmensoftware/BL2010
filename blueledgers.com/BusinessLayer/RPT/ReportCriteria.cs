...
namespace Blue.BL.RPT
{
    public class ReportCriteria : DbHandler
    {
        ...
        {
            SelectCommand = "SELECT * FROM RPT.ReportCriteria";
        ...
        {
            DbRetrieveSchema("RPT.GetReportCriteriaList", dsReportCriteria, null, TableName, connStr);
        }
        ...
        public bool GetList(DataSet dsReportCriteria, int reportID, string connStr)
        {
            ...
            return DbRetrieve("RPT.GetReportCriteria", dsReportCriteria, dbParams, TableName, connStr);
        }
        ...
        /// <param name="reportID"></param>
        /// <param name="connStr"></param>
        public bool GetListByReportID(DataSet dsReportCriteria, int reportID, string connStr)
        {
            var dbParams = new DbParameter[1];
            dbParams[0] = new DbParameter("@ReportID", reportID.ToString());

            return DbRetrieve("RPT.GetReportCriteriaByReportID", dsReportCriteria, dbParams, TableName, connStr);
        }
