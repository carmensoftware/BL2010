...
{
    public partial class PaymentTransBank : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            var molPaymentTransBankPopup =
                (AjaxControlToolkit.ModalPopupExtender) Parent.FindControl("MolPaymentTransBankPopup");
            molPaymentTransBankPopup.Show();
