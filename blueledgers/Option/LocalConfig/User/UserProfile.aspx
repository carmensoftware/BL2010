    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="popup-header">
                <asp:Label ID="LabelUserName" runat="server" Text="" Font-Size="Large" ForeColor="Blue"
            ...
            <div style="padding-left: 10px;">
                ...
                <div style="width: 240px; float: left;">
                    <table style="width: 100%; padding-right: 5px; line-height: 20px;">
                        <%--Status--%>
                        <tr>
                            <td>
                                <div style="float: right;">
                                    <div class="onoffswitch">
                                        <input id="ActiveUser" runat="server" type="checkbox" name="ActiveUser" class="onoffswitch-checkbox"
                                            checked>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:TextBox ID="TextLoginName" runat="server" Width="100%" />
                            </td>
                        </tr>
                        <%--Password--%>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="LabelBusinessUnit" runat="server" Font-Bold="True" Text="Primary BU" />
                                <asp:DropDownList ID="DdlBusinessUnit" runat="server" Width="100%" AutoPostBack="True" />
                                <asp:Label ID="LabelDepartment" runat="server" Font-Bold="True" Text="Department" />
                                <asp:DropDownList ID="DdlDepartment" runat="server" Width="100%" AutoPostBack="True" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="width: 120px; float: left; padding-left: 5px;">
                    ...
                    <dx:ASPxListBox ID="ListBU" runat="server" Width="100%" Height="420px" AutoPostBack="true"
                        OnSelectedIndexChanged="ListBU_SelectedIndexChanged">
                    </dx:ASPxListBox>
                </div>
                <!--Role-->
                <div style="width: 200px; float: left; padding-left: 5px;">
                    <div style="height: 20px; padding-left: 5px;">
                        ...
                        <div style="float: right">
                            <asp:Button ID="BtnRoleSelAll" runat="server" Text="All" Width="32px" Height="18px"
                                Font-Size="X-Small" OnClick="BtnRoleSelAll_Click" />
                            <asp:Button ID="BtnRoleSelNone" runat="server" Text="None" Width="36px" Height="18px"
                                Font-Size="X-Small" OnClick="BtnRoleSelNone_Click" />
                        </div>
                    </div>
                ...
                <div style="width: 280px; float: left; padding-left: 5px;">
                    <div style="height: 20px; padding-left: 5px;">
                        ...
                        <div style="float: right">
                            <asp:Button ID="BtnLocationSelAll" runat="server" Text="All" Width="32px" Height="18px"
                                Font-Size="X-Small" OnClick="BtnLocationSelAll_Click" />
                            <asp:Button ID="BtnLocationSelNone" runat="server" Text="None" Width="36px" Height="18px"
                                Font-Size="X-Small" OnClick="BtnLocationSelNone_Click" />
                        </div>
                    </div>
            ...
            <cc1:ModalPopupExtender ID="Pop_ChangePassword" runat="server" BehaviorID="Pop_ChangePassword"
                PopupControlID="Panel_ChangePassword" TargetControlID="HiddenField_ChangePassword"
                CancelControlID="BtnPopChangePasswordCancel" BackgroundCssClass="Background">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="Panel_ChangePassword" runat="server" CssClass="Popup" Width="320px"
                Height="220px">
                <div class="popup-header">
                    <h3>
                        Change Password
                ...
                <table style="width: 90%; margin: 0 auto;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextChangePasswordConfirm" runat="server" Text="" Width="180px"
                                TextMode="Password" />
                        </td>
                    </tr>
                </table>
            ...
            <%--Popup Delete User --%>
            <cc1:ModalPopupExtender ID="Pop_DelUserConfirm" runat="server" BehaviorID="Pop_DelUserConfirm"
                PopupControlID="Panel_DelUserConfirm" TargetControlID="HiddenField_DelUserConfirm"
                CancelControlID="BtnPopDelUserConfirmNo" BackgroundCssClass="Background">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="Panel_DelUserConfirm" runat="server" Style="display: block" CssClass="Popup"
            ...
            <%--Popup Add BU --%>
            <cc1:ModalPopupExtender ID="Pop_BuAdd" runat="server" BehaviorID="Pop_BuAdd" PopupControlID="Panel_BuAdd"
                TargetControlID="HiddenField_BuAdd" CancelControlID="BtnPopBuAddCancel" BackgroundCssClass="Background">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="Panel_BuAdd" runat="server" align="center" CssClass="Popup" Width="460px"
                Height="400px">
                <div style="margin: 0 auto;">
                    <p>
                        <asp:Label ID="LabelPopBuAddTitle" runat="server" Text="Available Business Unit"
                            Font-Size="14px" />
                    </p>
            ...
            <%--Popup Delete User --%>
            <cc1:ModalPopupExtender ID="Pop_BuDel" runat="server" BehaviorID="Pop_BuDel" PopupControlID="Panel_BuDel"
                TargetControlID="HiddenField_BuDel" CancelControlID="BtnPopBuDelNo" BackgroundCssClass="Background">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="Panel_BuDel" runat="server" Style="display: block" CssClass="Popup"
                Width="360px" Height="150px">
                <div class="popup-header" style="text-align: center">
                    <h4>
            ...
            <%--Popup MessageBox --%>
            <cc1:ModalPopupExtender ID="Pop_MessageBox" runat="server" BehaviorID="Pop_MessageBox"
                PopupControlID="Panel_MessageBox" TargetControlID="HiddenField_MessageBox" CancelControlID="BtnPopMessageBoxOk"
                BackgroundCssClass="Background">
            </cc1:ModalPopupExtender>
            <asp:Panel ID="Panel_MessageBox" runat="server" Style="display: block" CssClass="Popup"
                Width="320px" Height="120px" align="center">
                <div class="popup-header" style="text-align: center">
                    <h4>
