...
{
    public class VendorAttachment : DbHandler
    {
        #region "Attributies"
        ...
        {
            SelectCommand = "SELECT * FROM AP.VendorAttachment";
            TableName = "VendorAttachment";
        }
        ...
        public bool GetList(DataSet dsAttachment, string refNo, string connectionString)
        {
            ...
            return DbRetrieve("AP.GetVendorAttachmentListByRefNo", dsAttachment, dbParams, TableName, connectionString);
        }
        ...
        public bool GetStructure(DataSet dsAttachment, string connectionString)
        {
            ...
            return DbRetrieveSchema("AP.GetVendorAttachmentList", dsAttachment, null, TableName, connectionString);
        }
