...
{
    public class TransferDt : DbHandler
    {
        public TransferDt()
        {
            var SR = new Transfer();
            SelectCommand = "SELECT * FROM [IN].TransferDt";
            TableName = "TransferDt";
        }

        public bool GetStructure(DataSet dsStoreReqDt, string connStr)
        {
            return DbRetrieveSchema("[IN].[GetTrfDtSchema]", dsStoreReqDt, null, TableName, connStr);
        }
        ...
        public bool GetListByHeaderId(DataSet dsStoreReqDt, int DocumentId, string connStr)
        {
            ...
            //Get Data
            return DbRetrieve("[IN].[GetTrfDtByTrfId]", dsStoreReqDt, dbParams, TableName, connStr);
        }
        ...
        public bool GetDetailByItemId(DataSet dsStoreReqDt, int DocumentId, int itemId, string connStr)
        {
            ...
            //Get Data
            return DbRetrieve("[IN].[GetTrfDtByTrfIdAndTrfDtId]", dsStoreReqDt, dbParams, TableName, connStr);
        }
