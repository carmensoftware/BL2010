<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentDefaultAutoAccount.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentDefaultAutoAccount" %>
...
<script type="text/javascript">
        ...
        {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_txt_AutoAccount').value           = accountCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_txt_AutoAccount_Name').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_MolPaymentAutoAccountPoup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_MolPaymentAutoAccountPoup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
