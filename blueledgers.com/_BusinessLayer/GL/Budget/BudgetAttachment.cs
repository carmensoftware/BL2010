...
{
    public class BudgetAttachment : DbHandler
    {
        #region "Attributies"
        ...
        ///     Empty Contructor
        /// </summary>
        public BudgetAttachment()
        {
            SelectCommand = "SELECT * FROM GL.BudgetAttachment";
            TableName = "BudgetAttachment";
        }
        ...
        public bool GetList(DataSet dsBudgetAttachment, string RefNo, string ConnectionString)
        {
            ...
            return DbRetrieve("GL.GetBudgetAttachmentListByRefNo", dsBudgetAttachment, dbParams, TableName,
                ConnectionString);
        }
        ...
        public bool GetStructure(DataSet dsBudgetAttachment, string ConnectionString)
        {
            ...
            return DbRetrieveSchema("GL.GetBudgetAttachmentList", dsBudgetAttachment, null, TableName, ConnectionString);
        }
