<%@ Page Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="VendorMapp.aspx.cs" Inherits="BlueLedger.PL.Option.Admin.Interface.ACCPAC.VendorMapp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_Main" runat="Server">
        ...
        <tr style="background-color: #4d4d4d; height: 17px;">
            <td align="left" style="padding-left: 10px;">
                ...
                <table border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lbl_Title" runat="server" Text="<%$ Resources:Option.Admin.Interface.Sun.VendorMapp, lbl_Title %>" SkinID="LBL_HD_WHITE"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
            <td align="right">
                <dx:ASPxMenu ID="menu_CmdBar" runat="server" Font-Bold="True" BackColor="Transparent"
                    ...
                    Height="16px" onitemclick="menu_ItemClick">
    ...
    <asp:GridView ID="grd_VendorMapp" runat="server" AutoGenerateColumns="False" EnableModelValidation="True"
        ...
        <Columns>
            <asp:BoundField DataField="<%$ Resources:Option.Admin.Interface.Sun.VendorMapp, BuCode %>" Visible="false">
            <HeaderStyle HorizontalAlign="Left" />
            </asp:BoundField>
            <asp:BoundField HeaderText="<%$ Resources:Option.Admin.Interface.Sun.VendorMapp, BusinessUnit %>" DataField="BuName" Visible="false">
            <HeaderStyle HorizontalAlign="Left" />
            </asp:BoundField>
            <asp:BoundField HeaderText="<%$ Resources:Option.Admin.Interface.Sun.VendorMapp, HqCode %>" DataField="HQCode" >
            <HeaderStyle HorizontalAlign="Left" />
            </asp:BoundField>
            <asp:BoundField HeaderText="<%$ Resources:Option.Admin.Interface.Sun.VendorMapp, VendorName %>" DataField="Name" >
            <HeaderStyle HorizontalAlign="Left" />
            </asp:BoundField>
