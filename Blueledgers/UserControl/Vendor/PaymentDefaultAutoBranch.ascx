<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentDefaultAutoBranch.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentDefaultAutoBranch" %>
...
<script type="text/javascript">
       ...
       function BranchCode_Click(branchCode,branchName)
        {
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_txt_AutoBranchCode').value  = branchCode;
            window.document.getElementById('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_txt_AutoBranchName').innerText  = branchName;
            ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_MolPaymentAutoBranchPoup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_TabContainer1_TabPanel2_grd_Payment__ctl5_grd_AutoPayment__ctl2_MolPaymentAutoBranchPoup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
