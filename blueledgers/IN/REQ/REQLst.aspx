<%@ Page Title="" Language="C#" MasterPageFile="~/Master/In/SkinDefault.master" AutoEventWireup="true"
    CodeFile="REQLst.aspx.cs" Inherits="BlueLedger.PL.IN.REQ.REQLst" %>
                                    ...
                                    <dx:PanelContent ID = "PanelContent1" runat = "server">
                                        ...
                                        <%--<table border="0" cellpadding="1" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/IN/REQ/REQEdit.aspx">New</asp:HyperLink>
                                                </td>
                                                <td>
                        ...
                        <td align = "center">
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" Width = "100%">
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Requisition#" VisibleIndex="1">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Requisition Date" VisibleIndex="2">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="From Location" VisibleIndex="3">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Work-Flow Status" VisibleIndex="4">
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
