...
{
    public partial class PaymentDefaultTransAccount : BaseUserControl
    {
        #region "Attributies"
        ...
        protected void btn_Go_Click(object sender, EventArgs e)
        {
            ...
            AjaxControlToolkit.ModalPopupExtender MolPaymentTransAccountPoup = (AjaxControlToolkit.ModalPopupExtender)Parent.FindControl("MolPaymentTransAccountPoup");
            MolPaymentTransAccountPoup.Show();
        ...
        protected void grd_Result_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Attributes.Add("onDblClick", "TransAccountCode_Click('" + DataBinder.Eval(e.Row.DataItem, "AccountCode").ToString() +
