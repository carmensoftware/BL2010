<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PaymentTransVendorBank.ascx.cs"
    Inherits="BlueLedger.PL.UserControls.AP.PaymentTransVendorBank" %>
...
<script type="text/javascript">
       ...
       function TransVendorBankCode_Click(accountCode,accountName)
        {
            window.document.getElementById('_ctl0_cph_Main_txt_VTransBankCode').value      = accountCode;
            window.document.getElementById('_ctl0_cph_Main_txt_VTransBankName').innerText  = accountName;
            ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransVBankPopup');
        }
                    ...
                    <td align="right">
                        <table border="0" cellpadding="1" cellspacing="0">
                            <tr style="height: 25px">
                                ...
                                <td>
                                    <asp:LinkButton ID="lnkb_Close" runat="server" SkinID="LNKB_BOLD" OnClientClick="javascript:return ModalPoupExtenderHide('_ctl0_cph_Main_MolPaymentTransVBankPopup');">Close</asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </td>
